/**
 *  RecordCheckInEvent.js
 * 
 *  Record loyalty plus checkin event.
 * 
...
var logger = require('dw/system/Logger').getLogger("loyaltyplus-error", "RecordCheckInEvent.js");
...
function run(lpExternalCustomerId, marketingId) {
    ...
    try {
        ...
        var result = RecordEventService.run(lpExternalCustomerId, "checkin", null, null, null, marketingId).object;
