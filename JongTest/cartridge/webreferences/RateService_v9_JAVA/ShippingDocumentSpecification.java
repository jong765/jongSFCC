...
public class ShippingDocumentSpecification  implements java.io.Serializable {
     ...
     * shipper. */
    private com.fedex.ws.rate.v9.RequestedShippingDocumentType[] shippingDocumentTypes;

    private com.fedex.ws.rate.v9.CertificateOfOriginDetail certificateOfOrigin;

    private com.fedex.ws.rate.v9.CommercialInvoiceDetail commercialInvoiceDetail;

    /* Specifies the production of each package-level custom document
     * (the same specification is used for all packages). */
    private com.fedex.ws.rate.v9.CustomDocumentDetail customPackageDocumentDetail;

    /* Specifies the production of a shipment-level custom document. */
    private com.fedex.ws.rate.v9.CustomDocumentDetail customShipmentDocumentDetail;

    /* Details pertaining to the GAA. */
    private com.fedex.ws.rate.v9.GeneralAgencyAgreementDetail generalAgencyAgreementDetail;

    /* Details pertaining to NAFTA COO. */
    private com.fedex.ws.rate.v9.NaftaCertificateOfOriginDetail naftaCertificateOfOriginDetail;

    /* Specifies the production of the OP-900 document for hazardous
     * materials packages. */
    private com.fedex.ws.rate.v9.Op900Detail op900Detail;

    public ShippingDocumentSpecification() {
    }

    public ShippingDocumentSpecification(
           com.fedex.ws.rate.v9.RequestedShippingDocumentType[] shippingDocumentTypes,
           com.fedex.ws.rate.v9.CertificateOfOriginDetail certificateOfOrigin,
           com.fedex.ws.rate.v9.CommercialInvoiceDetail commercialInvoiceDetail,
           com.fedex.ws.rate.v9.CustomDocumentDetail customPackageDocumentDetail,
           com.fedex.ws.rate.v9.CustomDocumentDetail customShipmentDocumentDetail,
           com.fedex.ws.rate.v9.GeneralAgencyAgreementDetail generalAgencyAgreementDetail,
           com.fedex.ws.rate.v9.NaftaCertificateOfOriginDetail naftaCertificateOfOriginDetail,
           com.fedex.ws.rate.v9.Op900Detail op900Detail) {
     ...
     * shipper.
     */
    public com.fedex.ws.rate.v9.RequestedShippingDocumentType[] getShippingDocumentTypes() {
     ...
     * shipper.
     */
    public void setShippingDocumentTypes(com.fedex.ws.rate.v9.RequestedShippingDocumentType[] shippingDocumentTypes) {
        this.shippingDocumentTypes = shippingDocumentTypes;
    }

    public com.fedex.ws.rate.v9.RequestedShippingDocumentType getShippingDocumentTypes(int i) {
        return this.shippingDocumentTypes[i];
    }

    public void setShippingDocumentTypes(int i, com.fedex.ws.rate.v9.RequestedShippingDocumentType _value) {
     ...
     */
    public com.fedex.ws.rate.v9.CertificateOfOriginDetail getCertificateOfOrigin() {
        return certificateOfOrigin;
    }
     ...
     */
    public void setCertificateOfOrigin(com.fedex.ws.rate.v9.CertificateOfOriginDetail certificateOfOrigin) {
        this.certificateOfOrigin = certificateOfOrigin;
    }
     ...
     */
    public com.fedex.ws.rate.v9.CommercialInvoiceDetail getCommercialInvoiceDetail() {
        return commercialInvoiceDetail;
    }
     ...
     */
    public void setCommercialInvoiceDetail(com.fedex.ws.rate.v9.CommercialInvoiceDetail commercialInvoiceDetail) {
        this.commercialInvoiceDetail = commercialInvoiceDetail;
    }
     ...
     * (the same specification is used for all packages).
     */
    public com.fedex.ws.rate.v9.CustomDocumentDetail getCustomPackageDocumentDetail() {
     ...
     * (the same specification is used for all packages).
     */
    public void setCustomPackageDocumentDetail(com.fedex.ws.rate.v9.CustomDocumentDetail customPackageDocumentDetail) {
        this.customPackageDocumentDetail = customPackageDocumentDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.CustomDocumentDetail getCustomShipmentDocumentDetail() {
     ...
     */
    public void setCustomShipmentDocumentDetail(com.fedex.ws.rate.v9.CustomDocumentDetail customShipmentDocumentDetail) {
        this.customShipmentDocumentDetail = customShipmentDocumentDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.GeneralAgencyAgreementDetail getGeneralAgencyAgreementDetail() {
     ...
     */
    public void setGeneralAgencyAgreementDetail(com.fedex.ws.rate.v9.GeneralAgencyAgreementDetail generalAgencyAgreementDetail) {
        this.generalAgencyAgreementDetail = generalAgencyAgreementDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.NaftaCertificateOfOriginDetail getNaftaCertificateOfOriginDetail() {
     ...
     */
    public void setNaftaCertificateOfOriginDetail(com.fedex.ws.rate.v9.NaftaCertificateOfOriginDetail naftaCertificateOfOriginDetail) {
        this.naftaCertificateOfOriginDetail = naftaCertificateOfOriginDetail;
    }
     ...
     * materials packages.
     */
    public com.fedex.ws.rate.v9.Op900Detail getOp900Detail() {
        return op900Detail;
    }
     ...
     * materials packages.
     */
    public void setOp900Detail(com.fedex.ws.rate.v9.Op900Detail op900Detail) {
        this.op900Detail = op900Detail;
    }
