...
public class DangerousGoodsDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.DangerousGoodsAccessibilityType accessibility;
     ...
     * package. */
    private com.fedex.ws.rate.v9.HazardousCommodityOptionType[] options;

    /* Documents the kinds and quantities of all hazardous commodities
     * in the current package. */
    private com.fedex.ws.rate.v9.HazardousCommodityContent[] hazardousCommodities;

    /* Description of the packaging of this commodity, suitable for
     * use on OP-900 and OP-950 forms. */
    private com.fedex.ws.rate.v9.HazardousCommodityPackagingDetail packaging;
    ...
    public DangerousGoodsDetail(
           com.fedex.ws.rate.v9.DangerousGoodsAccessibilityType accessibility,
           java.lang.Boolean cargoAircraftOnly,
           com.fedex.ws.rate.v9.HazardousCommodityOptionType[] options,
           com.fedex.ws.rate.v9.HazardousCommodityContent[] hazardousCommodities,
           com.fedex.ws.rate.v9.HazardousCommodityPackagingDetail packaging,
     ...
     * to be accessible during delivery.
     */
    public com.fedex.ws.rate.v9.DangerousGoodsAccessibilityType getAccessibility() {
     ...
     * to be accessible during delivery.
     */
    public void setAccessibility(com.fedex.ws.rate.v9.DangerousGoodsAccessibilityType accessibility) {
        this.accessibility = accessibility;
    }
     ...
     * package.
     */
    public com.fedex.ws.rate.v9.HazardousCommodityOptionType[] getOptions() {
        return options;
    }
     ...
     * package.
     */
    public void setOptions(com.fedex.ws.rate.v9.HazardousCommodityOptionType[] options) {
        this.options = options;
    }

    public com.fedex.ws.rate.v9.HazardousCommodityOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.fedex.ws.rate.v9.HazardousCommodityOptionType _value) {
     ...
     * in the current package.
     */
    public com.fedex.ws.rate.v9.HazardousCommodityContent[] getHazardousCommodities() {
     ...
     * in the current package.
     */
    public void setHazardousCommodities(com.fedex.ws.rate.v9.HazardousCommodityContent[] hazardousCommodities) {
        this.hazardousCommodities = hazardousCommodities;
    }

    public com.fedex.ws.rate.v9.HazardousCommodityContent getHazardousCommodities(int i) {
        return this.hazardousCommodities[i];
    }

    public void setHazardousCommodities(int i, com.fedex.ws.rate.v9.HazardousCommodityContent _value) {
     ...
     * use on OP-900 and OP-950 forms.
     */
    public com.fedex.ws.rate.v9.HazardousCommodityPackagingDetail getPackaging() {
        return packaging;
    }
     ...
     * use on OP-900 and OP-950 forms.
     */
    public void setPackaging(com.fedex.ws.rate.v9.HazardousCommodityPackagingDetail packaging) {
        this.packaging = packaging;
    }
