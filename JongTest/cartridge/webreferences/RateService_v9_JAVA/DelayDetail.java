...
public class DelayDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.DelayLevelType level;

    /* The point where the delay is occurring (e.g. Origin, Destination,
     * Broker location) */
    private com.fedex.ws.rate.v9.DelayPointType point;

    /* The reason for the delay (e.g. holiday, weekend, etc.). */
    private com.fedex.ws.rate.v9.CommitmentDelayType type;
    ...
    public DelayDetail(
           ...
           com.fedex.ws.rate.v9.DelayLevelType level,
           com.fedex.ws.rate.v9.DelayPointType point,
           com.fedex.ws.rate.v9.CommitmentDelayType type,
     ...
     * City, LocationId, Zip, service area, special handling )
     */
    public com.fedex.ws.rate.v9.DelayLevelType getLevel() {
        return level;
    }
     ...
     * City, LocationId, Zip, service area, special handling )
     */
    public void setLevel(com.fedex.ws.rate.v9.DelayLevelType level) {
        this.level = level;
    }
     ...
     * Broker location)
     */
    public com.fedex.ws.rate.v9.DelayPointType getPoint() {
        return point;
    }
     ...
     * Broker location)
     */
    public void setPoint(com.fedex.ws.rate.v9.DelayPointType point) {
        this.point = point;
    }
     ...
     */
    public com.fedex.ws.rate.v9.CommitmentDelayType getType() {
        return type;
    }
     ...
     */
    public void setType(com.fedex.ws.rate.v9.CommitmentDelayType type) {
        this.type = type;
    }
