...
public class ShippingDocumentEMailDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.ShippingDocumentEMailRecipient[] EMailRecipients;

    /* Identifies the convention by which documents are to be grouped
     * as e-mail attachments. */
    private com.fedex.ws.rate.v9.ShippingDocumentEMailGroupingType grouping;

    public ShippingDocumentEMailDetail() {
    }

    public ShippingDocumentEMailDetail(
           com.fedex.ws.rate.v9.ShippingDocumentEMailRecipient[] EMailRecipients,
           com.fedex.ws.rate.v9.ShippingDocumentEMailGroupingType grouping) {
     ...
     */
    public com.fedex.ws.rate.v9.ShippingDocumentEMailRecipient[] getEMailRecipients() {
     ...
     */
    public void setEMailRecipients(com.fedex.ws.rate.v9.ShippingDocumentEMailRecipient[] EMailRecipients) {
        this.EMailRecipients = EMailRecipients;
    }

    public com.fedex.ws.rate.v9.ShippingDocumentEMailRecipient getEMailRecipients(int i) {
        return this.EMailRecipients[i];
    }

    public void setEMailRecipients(int i, com.fedex.ws.rate.v9.ShippingDocumentEMailRecipient _value) {
     ...
     * as e-mail attachments.
     */
    public com.fedex.ws.rate.v9.ShippingDocumentEMailGroupingType getGrouping() {
        return grouping;
    }
     ...
     * as e-mail attachments.
     */
    public void setGrouping(com.fedex.ws.rate.v9.ShippingDocumentEMailGroupingType grouping) {
        this.grouping = grouping;
    }
