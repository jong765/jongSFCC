...
public class DestinationControlDetail  implements java.io.Serializable {
    private com.fedex.ws.rate.v9.DestinationControlStatementType[] statementTypes;
    ...
    public DestinationControlDetail(
           com.fedex.ws.rate.v9.DestinationControlStatementType[] statementTypes,
     ...
     */
    public com.fedex.ws.rate.v9.DestinationControlStatementType[] getStatementTypes() {
        return statementTypes;
    }
     ...
     */
    public void setStatementTypes(com.fedex.ws.rate.v9.DestinationControlStatementType[] statementTypes) {
        this.statementTypes = statementTypes;
    }

    public com.fedex.ws.rate.v9.DestinationControlStatementType getStatementTypes(int i) {
        return this.statementTypes[i];
    }

    public void setStatementTypes(int i, com.fedex.ws.rate.v9.DestinationControlStatementType _value) {
