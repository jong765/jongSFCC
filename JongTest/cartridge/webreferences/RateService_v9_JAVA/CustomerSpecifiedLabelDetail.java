...
public class CustomerSpecifiedLabelDetail  implements java.io.Serializable {
     ...
     * NONE type). */
    private com.fedex.ws.rate.v9.DocTabContent docTabContent;

    /* Defines any custom content to print on the label. */
    private com.fedex.ws.rate.v9.CustomLabelDetail customContent;
    ...
    private com.fedex.ws.rate.v9.ConfigurableLabelReferenceEntry[] configurableReferenceEntries;

    /* Controls which data/sections will be suppressed. */
    private com.fedex.ws.rate.v9.LabelMaskableDataType[] maskedData;

    /* The language to use when printing the terms and conditions
     * on the label. */
    private com.fedex.ws.rate.v9.Localization termsAndConditionsLocalization;

    /* Controls the number of additional copies of supplemental labels. */
    private com.fedex.ws.rate.v9.AdditionalLabelsDetail[] additionalLabels;
    ...
    public CustomerSpecifiedLabelDetail(
           com.fedex.ws.rate.v9.DocTabContent docTabContent,
           com.fedex.ws.rate.v9.CustomLabelDetail customContent,
           com.fedex.ws.rate.v9.ConfigurableLabelReferenceEntry[] configurableReferenceEntries,
           com.fedex.ws.rate.v9.LabelMaskableDataType[] maskedData,
           com.fedex.ws.rate.v9.Localization termsAndConditionsLocalization,
           com.fedex.ws.rate.v9.AdditionalLabelsDetail[] additionalLabels,
     ...
     * NONE type).
     */
    public com.fedex.ws.rate.v9.DocTabContent getDocTabContent() {
     ...
     * NONE type).
     */
    public void setDocTabContent(com.fedex.ws.rate.v9.DocTabContent docTabContent) {
        this.docTabContent = docTabContent;
    }
     ...
     */
    public com.fedex.ws.rate.v9.CustomLabelDetail getCustomContent() {
     ...
     */
    public void setCustomContent(com.fedex.ws.rate.v9.CustomLabelDetail customContent) {
        this.customContent = customContent;
    }
     ...
     * the label that can also be printed on the doc tab.
     */
    public com.fedex.ws.rate.v9.ConfigurableLabelReferenceEntry[] getConfigurableReferenceEntries() {
     ...
     * the label that can also be printed on the doc tab.
     */
    public void setConfigurableReferenceEntries(com.fedex.ws.rate.v9.ConfigurableLabelReferenceEntry[] configurableReferenceEntries) {
        this.configurableReferenceEntries = configurableReferenceEntries;
    }

    public com.fedex.ws.rate.v9.ConfigurableLabelReferenceEntry getConfigurableReferenceEntries(int i) {
        return this.configurableReferenceEntries[i];
    }

    public void setConfigurableReferenceEntries(int i, com.fedex.ws.rate.v9.ConfigurableLabelReferenceEntry _value) {
     ...
     */
    public com.fedex.ws.rate.v9.LabelMaskableDataType[] getMaskedData() {
        return maskedData;
    }
     ...
     */
    public void setMaskedData(com.fedex.ws.rate.v9.LabelMaskableDataType[] maskedData) {
        this.maskedData = maskedData;
    }

    public com.fedex.ws.rate.v9.LabelMaskableDataType getMaskedData(int i) {
        return this.maskedData[i];
    }

    public void setMaskedData(int i, com.fedex.ws.rate.v9.LabelMaskableDataType _value) {
     ...
     * on the label.
     */
    public com.fedex.ws.rate.v9.Localization getTermsAndConditionsLocalization() {
     ...
     * on the label.
     */
    public void setTermsAndConditionsLocalization(com.fedex.ws.rate.v9.Localization termsAndConditionsLocalization) {
        this.termsAndConditionsLocalization = termsAndConditionsLocalization;
    }
     ...
     */
    public com.fedex.ws.rate.v9.AdditionalLabelsDetail[] getAdditionalLabels() {
     ...
     */
    public void setAdditionalLabels(com.fedex.ws.rate.v9.AdditionalLabelsDetail[] additionalLabels) {
        this.additionalLabels = additionalLabels;
    }

    public com.fedex.ws.rate.v9.AdditionalLabelsDetail getAdditionalLabels(int i) {
        return this.additionalLabels[i];
    }

    public void setAdditionalLabels(int i, com.fedex.ws.rate.v9.AdditionalLabelsDetail _value) {
