...
public class RequestedPackageLineItem  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.Money insuredValue;

    /* Only used for INDIVIDUAL_PACKAGES and PACKAGE_GROUPS. Ignored
     * for PACKAGE_SUMMARY, in which case totalweight and packageCount on
     * the shipment will be used to determine this value. */
    private com.fedex.ws.rate.v9.Weight weight;

    private com.fedex.ws.rate.v9.Dimensions dimensions;
    ...
    private com.fedex.ws.rate.v9.PhysicalPackagingType physicalPackaging;

    /* Human-readable text describing the package. */
    private java.lang.String itemDescription;

    private com.fedex.ws.rate.v9.CustomerReference[] customerReferences;

    private com.fedex.ws.rate.v9.PackageSpecialServicesRequested specialServicesRequested;

    /* Only used for INDIVIDUAL_PACKAGES and PACKAGE_GROUPS. */
    private com.fedex.ws.rate.v9.ContentRecord[] contentRecords;
    ...
    public RequestedPackageLineItem(
           ...
           com.fedex.ws.rate.v9.Money insuredValue,
           com.fedex.ws.rate.v9.Weight weight,
           com.fedex.ws.rate.v9.Dimensions dimensions,
           com.fedex.ws.rate.v9.PhysicalPackagingType physicalPackaging,
           java.lang.String itemDescription,
           com.fedex.ws.rate.v9.CustomerReference[] customerReferences,
           com.fedex.ws.rate.v9.PackageSpecialServicesRequested specialServicesRequested,
           com.fedex.ws.rate.v9.ContentRecord[] contentRecords) {
     ...
     * on the shipment will be used to determine this value.
     */
    public com.fedex.ws.rate.v9.Money getInsuredValue() {
        return insuredValue;
    }
     ...
     * on the shipment will be used to determine this value.
     */
    public void setInsuredValue(com.fedex.ws.rate.v9.Money insuredValue) {
        this.insuredValue = insuredValue;
    }
     ...
     * the shipment will be used to determine this value.
     */
    public com.fedex.ws.rate.v9.Weight getWeight() {
        return weight;
    }
     ...
     * the shipment will be used to determine this value.
     */
    public void setWeight(com.fedex.ws.rate.v9.Weight weight) {
        this.weight = weight;
    }
     ...
     * @return dimensions
     */
    public com.fedex.ws.rate.v9.Dimensions getDimensions() {
        return dimensions;
    }
     ...
     * @param dimensions
     */
    public void setDimensions(com.fedex.ws.rate.v9.Dimensions dimensions) {
        this.dimensions = dimensions;
    }
     ...
     * under international and SmartPost services.
     */
    public com.fedex.ws.rate.v9.PhysicalPackagingType getPhysicalPackaging() {
     ...
     * under international and SmartPost services.
     */
    public void setPhysicalPackaging(com.fedex.ws.rate.v9.PhysicalPackagingType physicalPackaging) {
        this.physicalPackaging = physicalPackaging;
    }
     ...
     */
    public com.fedex.ws.rate.v9.CustomerReference[] getCustomerReferences() {
        return customerReferences;
    }
     ...
     */
    public void setCustomerReferences(com.fedex.ws.rate.v9.CustomerReference[] customerReferences) {
        this.customerReferences = customerReferences;
    }

    public com.fedex.ws.rate.v9.CustomerReference getCustomerReferences(int i) {
        return this.customerReferences[i];
    }

    public void setCustomerReferences(int i, com.fedex.ws.rate.v9.CustomerReference _value) {
     ...
     */
    public com.fedex.ws.rate.v9.PackageSpecialServicesRequested getSpecialServicesRequested() {
        return specialServicesRequested;
    }
     ...
     */
    public void setSpecialServicesRequested(com.fedex.ws.rate.v9.PackageSpecialServicesRequested specialServicesRequested) {
        this.specialServicesRequested = specialServicesRequested;
    }
     ...
     */
    public com.fedex.ws.rate.v9.ContentRecord[] getContentRecords() {
     ...
     */
    public void setContentRecords(com.fedex.ws.rate.v9.ContentRecord[] contentRecords) {
        this.contentRecords = contentRecords;
    }

    public com.fedex.ws.rate.v9.ContentRecord getContentRecords(int i) {
        return this.contentRecords[i];
    }

    public void setContentRecords(int i, com.fedex.ws.rate.v9.ContentRecord _value) {
