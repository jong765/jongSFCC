...
public class DocTabContent  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.DocTabContentType docTabContentType;

    /* The DocTabContentType should be set to ZONE001 to specify additional
     * Zone details. */
    private com.fedex.ws.rate.v9.DocTabZoneSpecification[] zone001;

    /* The DocTabContentType should be set to BARCODED to specify
     * additional BarCoded details. */
    private com.fedex.ws.rate.v9.DocTabContentBarcoded barcoded;

    public DocTabContent() {
    }

    public DocTabContent(
           com.fedex.ws.rate.v9.DocTabContentType docTabContentType,
           com.fedex.ws.rate.v9.DocTabZoneSpecification[] zone001,
           com.fedex.ws.rate.v9.DocTabContentBarcoded barcoded) {
     ...
     */
    public com.fedex.ws.rate.v9.DocTabContentType getDocTabContentType() {
     ...
     */
    public void setDocTabContentType(com.fedex.ws.rate.v9.DocTabContentType docTabContentType) {
        this.docTabContentType = docTabContentType;
    }
     ...
     * Zone details.
     */
    public com.fedex.ws.rate.v9.DocTabZoneSpecification[] getZone001() {
        return zone001;
    }
     ...
     * Zone details.
     */
    public void setZone001(com.fedex.ws.rate.v9.DocTabZoneSpecification[] zone001) {
        this.zone001 = zone001;
    }
     ...
     * additional BarCoded details.
     */
    public com.fedex.ws.rate.v9.DocTabContentBarcoded getBarcoded() {
        return barcoded;
    }
     ...
     * additional BarCoded details.
     */
    public void setBarcoded(com.fedex.ws.rate.v9.DocTabContentBarcoded barcoded) {
        this.barcoded = barcoded;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v9", "DocTabZoneSpecifications"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
