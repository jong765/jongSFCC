...
public class NaftaCommodityDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.NaftaPreferenceCriterionCode preferenceCriterion;

    /* Defined by NAFTA regulations. */
    private com.fedex.ws.rate.v9.NaftaProducerDeterminationCode producerDetermination;
    ...
    private com.fedex.ws.rate.v9.NaftaNetCostMethodCode netCostMethod;

    /* Date range over which RVC net cost was calculated. */
    private com.fedex.ws.rate.v9.DateRange netCostDateRange;

    public NaftaCommodityDetail() {
    }

    public NaftaCommodityDetail(
           com.fedex.ws.rate.v9.NaftaPreferenceCriterionCode preferenceCriterion,
           com.fedex.ws.rate.v9.NaftaProducerDeterminationCode producerDetermination,
           java.lang.String producerId,
           com.fedex.ws.rate.v9.NaftaNetCostMethodCode netCostMethod,
           com.fedex.ws.rate.v9.DateRange netCostDateRange) {
     ...
     */
    public com.fedex.ws.rate.v9.NaftaPreferenceCriterionCode getPreferenceCriterion() {
     ...
     */
    public void setPreferenceCriterion(com.fedex.ws.rate.v9.NaftaPreferenceCriterionCode preferenceCriterion) {
        this.preferenceCriterion = preferenceCriterion;
    }
     ...
     */
    public com.fedex.ws.rate.v9.NaftaProducerDeterminationCode getProducerDetermination() {
     ...
     */
    public void setProducerDetermination(com.fedex.ws.rate.v9.NaftaProducerDeterminationCode producerDetermination) {
        this.producerDetermination = producerDetermination;
    }
     ...
     */
    public com.fedex.ws.rate.v9.NaftaNetCostMethodCode getNetCostMethod() {
        return netCostMethod;
    }
     ...
     * @param netCostMethod
     */
    public void setNetCostMethod(com.fedex.ws.rate.v9.NaftaNetCostMethodCode netCostMethod) {
        this.netCostMethod = netCostMethod;
    }
     ...
     */
    public com.fedex.ws.rate.v9.DateRange getNetCostDateRange() {
     ...
     */
    public void setNetCostDateRange(com.fedex.ws.rate.v9.DateRange netCostDateRange) {
        this.netCostDateRange = netCostDateRange;
    }
