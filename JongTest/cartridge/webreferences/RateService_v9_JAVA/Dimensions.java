...
public class Dimensions  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.LinearUnits units;
    ...
    public Dimensions(
           ...
           com.fedex.ws.rate.v9.LinearUnits units) {
           this.length = length;
           this.width = width;
           this.height = height;
           this.units = units;
     ...
     * @return units
     */
    public com.fedex.ws.rate.v9.LinearUnits getUnits() {
        return units;
    }
     ...
     * @param units
     */
    public void setUnits(com.fedex.ws.rate.v9.LinearUnits units) {
        this.units = units;
    }
