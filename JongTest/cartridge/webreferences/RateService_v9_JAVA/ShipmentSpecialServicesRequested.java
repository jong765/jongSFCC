...
public class ShipmentSpecialServicesRequested  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.ShipmentSpecialServiceType[] specialServiceTypes;
    ...
    private com.fedex.ws.rate.v9.HoldAtLocationDetail holdAtLocationDetail;
     ...
     * collection. */
    private com.fedex.ws.rate.v9.EMailNotificationDetail EMailNotificationDetail;
     ...
     * is present in the SpecialServiceTypes collection */
    private com.fedex.ws.rate.v9.ReturnShipmentDetail returnShipmentDetail;
     ...
     * type. */
    private com.fedex.ws.rate.v9.PendingShipmentDetail pendingShipmentDetail;

    /* The number of packages with dry ice and the total weight of
     * the dry ice. */
    private com.fedex.ws.rate.v9.ShipmentDryIceDetail shipmentDryIceDetail;
     ...
     * is present in the SpecialServiceTypes collection */
    private com.fedex.ws.rate.v9.HomeDeliveryPremiumDetail homeDeliveryPremiumDetail;

    private com.fedex.ws.rate.v9.FlatbedTrailerOption[] flatbedTrailerDetail;

    private com.fedex.ws.rate.v9.FreightGuaranteeDetail freightGuaranteeDetail;

    /* Electronic Trade document references. */
    private com.fedex.ws.rate.v9.EtdDetail etdDetail;

    /* Specification for date or range of dates on which delivery
     * is to be attempted. */
    private com.fedex.ws.rate.v9.CustomDeliveryWindowDetail customDeliveryWindowDetail;

    public ShipmentSpecialServicesRequested() {
    }

    public ShipmentSpecialServicesRequested(
           com.fedex.ws.rate.v9.ShipmentSpecialServiceType[] specialServiceTypes,
           com.fedex.ws.rate.v9.CodDetail codDetail,
           com.fedex.ws.rate.v9.HoldAtLocationDetail holdAtLocationDetail,
           com.fedex.ws.rate.v9.EMailNotificationDetail EMailNotificationDetail,
           com.fedex.ws.rate.v9.ReturnShipmentDetail returnShipmentDetail,
           com.fedex.ws.rate.v9.PendingShipmentDetail pendingShipmentDetail,
           com.fedex.ws.rate.v9.ShipmentDryIceDetail shipmentDryIceDetail,
           com.fedex.ws.rate.v9.HomeDeliveryPremiumDetail homeDeliveryPremiumDetail,
           com.fedex.ws.rate.v9.FlatbedTrailerOption[] flatbedTrailerDetail,
           com.fedex.ws.rate.v9.FreightGuaranteeDetail freightGuaranteeDetail,
           com.fedex.ws.rate.v9.EtdDetail etdDetail,
           com.fedex.ws.rate.v9.CustomDeliveryWindowDetail customDeliveryWindowDetail) {
     ...
     * shipment (or other shipment-level transaction).
     */
    public com.fedex.ws.rate.v9.ShipmentSpecialServiceType[] getSpecialServiceTypes() {
     ...
     * shipment (or other shipment-level transaction).
     */
    public void setSpecialServiceTypes(com.fedex.ws.rate.v9.ShipmentSpecialServiceType[] specialServiceTypes) {
        this.specialServiceTypes = specialServiceTypes;
    }

    public com.fedex.ws.rate.v9.ShipmentSpecialServiceType getSpecialServiceTypes(int i) {
        return this.specialServiceTypes[i];
    }

    public void setSpecialServiceTypes(int i, com.fedex.ws.rate.v9.ShipmentSpecialServiceType _value) {
     ...
     * is present in the SpecialServiceTypes collection.
     */
    public com.fedex.ws.rate.v9.HoldAtLocationDetail getHoldAtLocationDetail() {
     ...
     * is present in the SpecialServiceTypes collection.
     */
    public void setHoldAtLocationDetail(com.fedex.ws.rate.v9.HoldAtLocationDetail holdAtLocationDetail) {
        this.holdAtLocationDetail = holdAtLocationDetail;
    }
     ...
     * collection.
     */
    public com.fedex.ws.rate.v9.EMailNotificationDetail getEMailNotificationDetail() {
     ...
     * collection.
     */
    public void setEMailNotificationDetail(com.fedex.ws.rate.v9.EMailNotificationDetail EMailNotificationDetail) {
        this.EMailNotificationDetail = EMailNotificationDetail;
    }
     ...
     * is present in the SpecialServiceTypes collection
     */
    public com.fedex.ws.rate.v9.ReturnShipmentDetail getReturnShipmentDetail() {
     ...
     * is present in the SpecialServiceTypes collection
     */
    public void setReturnShipmentDetail(com.fedex.ws.rate.v9.ReturnShipmentDetail returnShipmentDetail) {
        this.returnShipmentDetail = returnShipmentDetail;
    }
     ...
     * type.
     */
    public com.fedex.ws.rate.v9.PendingShipmentDetail getPendingShipmentDetail() {
     ...
     * type.
     */
    public void setPendingShipmentDetail(com.fedex.ws.rate.v9.PendingShipmentDetail pendingShipmentDetail) {
        this.pendingShipmentDetail = pendingShipmentDetail;
    }
     ...
     * the dry ice.
     */
    public com.fedex.ws.rate.v9.ShipmentDryIceDetail getShipmentDryIceDetail() {
     ...
     * the dry ice.
     */
    public void setShipmentDryIceDetail(com.fedex.ws.rate.v9.ShipmentDryIceDetail shipmentDryIceDetail) {
        this.shipmentDryIceDetail = shipmentDryIceDetail;
    }
     ...
     * is present in the SpecialServiceTypes collection
     */
    public com.fedex.ws.rate.v9.HomeDeliveryPremiumDetail getHomeDeliveryPremiumDetail() {
     ...
     * is present in the SpecialServiceTypes collection
     */
    public void setHomeDeliveryPremiumDetail(com.fedex.ws.rate.v9.HomeDeliveryPremiumDetail homeDeliveryPremiumDetail) {
        this.homeDeliveryPremiumDetail = homeDeliveryPremiumDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.FlatbedTrailerOption[] getFlatbedTrailerDetail() {
        return flatbedTrailerDetail;
    }
     ...
     */
    public void setFlatbedTrailerDetail(com.fedex.ws.rate.v9.FlatbedTrailerOption[] flatbedTrailerDetail) {
        this.flatbedTrailerDetail = flatbedTrailerDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.FreightGuaranteeDetail getFreightGuaranteeDetail() {
        return freightGuaranteeDetail;
    }
     ...
     */
    public void setFreightGuaranteeDetail(com.fedex.ws.rate.v9.FreightGuaranteeDetail freightGuaranteeDetail) {
        this.freightGuaranteeDetail = freightGuaranteeDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.EtdDetail getEtdDetail() {
        return etdDetail;
    }
     ...
     */
    public void setEtdDetail(com.fedex.ws.rate.v9.EtdDetail etdDetail) {
        this.etdDetail = etdDetail;
    }
     ...
     * is to be attempted.
     */
    public com.fedex.ws.rate.v9.CustomDeliveryWindowDetail getCustomDeliveryWindowDetail() {
     ...
     * is to be attempted.
     */
    public void setCustomDeliveryWindowDetail(com.fedex.ws.rate.v9.CustomDeliveryWindowDetail customDeliveryWindowDetail) {
        this.customDeliveryWindowDetail = customDeliveryWindowDetail;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v9", "Options"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
