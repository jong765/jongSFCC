...
public class CodDetail  implements java.io.Serializable {
    private com.fedex.ws.rate.v9.Money codCollectionAmount;
    ...
    private com.fedex.ws.rate.v9.CodAddTransportationChargesType addTransportationCharges;

    /* Identifies the type of funds FedEx should collect upon package
     * delivery */
    private com.fedex.ws.rate.v9.CodCollectionType collectionType;
    ...
    private com.fedex.ws.rate.v9.Party codRecipient;

    /* Indicates which type of reference information to include on
     * the COD return shipping label. */
    private com.fedex.ws.rate.v9.CodReturnReferenceIndicatorType referenceIndicator;

    public CodDetail() {
    }

    public CodDetail(
           com.fedex.ws.rate.v9.Money codCollectionAmount,
           com.fedex.ws.rate.v9.CodAddTransportationChargesType addTransportationCharges,
           com.fedex.ws.rate.v9.CodCollectionType collectionType,
           com.fedex.ws.rate.v9.Party codRecipient,
           com.fedex.ws.rate.v9.CodReturnReferenceIndicatorType referenceIndicator) {
     ...
     */
    public com.fedex.ws.rate.v9.Money getCodCollectionAmount() {
        return codCollectionAmount;
    }
     ...
     */
    public void setCodCollectionAmount(com.fedex.ws.rate.v9.Money codCollectionAmount) {
        this.codCollectionAmount = codCollectionAmount;
    }
     ...
     * of valid enumerated values.
     */
    public com.fedex.ws.rate.v9.CodAddTransportationChargesType getAddTransportationCharges() {
     ...
     * of valid enumerated values.
     */
    public void setAddTransportationCharges(com.fedex.ws.rate.v9.CodAddTransportationChargesType addTransportationCharges) {
        this.addTransportationCharges = addTransportationCharges;
    }
     ...
     * delivery
     */
    public com.fedex.ws.rate.v9.CodCollectionType getCollectionType() {
     ...
     * delivery
     */
    public void setCollectionType(com.fedex.ws.rate.v9.CodCollectionType collectionType) {
        this.collectionType = collectionType;
    }
     ...
     * that prints the COD receipt.
     */
    public com.fedex.ws.rate.v9.Party getCodRecipient() {
        return codRecipient;
    }
     ...
     * that prints the COD receipt.
     */
    public void setCodRecipient(com.fedex.ws.rate.v9.Party codRecipient) {
        this.codRecipient = codRecipient;
    }
     ...
     * the COD return shipping label.
     */
    public com.fedex.ws.rate.v9.CodReturnReferenceIndicatorType getReferenceIndicator() {
     ...
     * the COD return shipping label.
     */
    public void setReferenceIndicator(com.fedex.ws.rate.v9.CodReturnReferenceIndicatorType referenceIndicator) {
        this.referenceIndicator = referenceIndicator;
    }
