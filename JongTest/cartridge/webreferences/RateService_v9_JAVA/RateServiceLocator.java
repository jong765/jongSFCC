...
public class RateServiceLocator extends org.apache.axis.client.Service implements com.fedex.ws.rate.v9.RateService {
    ...
    private java.lang.String RateServicePort_address = "https://gatewaybeta.fedex.com:443/web-services";
    ...
    public com.fedex.ws.rate.v9.RatePortType getRateServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.fedex.ws.rate.v9.RatePortType getRateServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fedex.ws.rate.v9.RateServiceSoapBindingStub _stub = new com.fedex.ws.rate.v9.RateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.fedex.ws.rate.v9.RatePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fedex.ws.rate.v9.RateServiceSoapBindingStub _stub = new com.fedex.ws.rate.v9.RateServiceSoapBindingStub(new java.net.URL(RateServicePort_address), this);
                _stub.setPortName(getRateServicePortWSDDServiceName());
                return _stub;
            }
        }
