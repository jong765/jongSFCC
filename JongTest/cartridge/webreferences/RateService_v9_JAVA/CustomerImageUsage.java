...
public class CustomerImageUsage  implements java.io.Serializable {
    private com.fedex.ws.rate.v9.CustomerImageUsageType type;

    private com.fedex.ws.rate.v9.ImageId id;

    public CustomerImageUsage() {
    }

    public CustomerImageUsage(
           com.fedex.ws.rate.v9.CustomerImageUsageType type,
           com.fedex.ws.rate.v9.ImageId id) {
           this.type = type;
           this.id = id;
    }
     ...
     * @return type
     */
    public com.fedex.ws.rate.v9.CustomerImageUsageType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.fedex.ws.rate.v9.CustomerImageUsageType type) {
        this.type = type;
    }
     ...
     * @return id
     */
    public com.fedex.ws.rate.v9.ImageId getId() {
        return id;
    }
     ...
     * @param id
     */
    public void setId(com.fedex.ws.rate.v9.ImageId id) {
        this.id = id;
    }
