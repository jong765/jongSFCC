...
public class ServiceSubOptionDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.FreightGuaranteeType freightGuarantee;
     ...
     * is a variable option on the rate request. */
    private com.fedex.ws.rate.v9.SmartPostIndiciaType smartPostIndicia;

    public ServiceSubOptionDetail() {
    }

    public ServiceSubOptionDetail(
           com.fedex.ws.rate.v9.FreightGuaranteeType freightGuarantee,
           java.lang.String smartPostHubId,
           com.fedex.ws.rate.v9.SmartPostIndiciaType smartPostIndicia) {
     ...
     * is applied to the rate quote.
     */
    public com.fedex.ws.rate.v9.FreightGuaranteeType getFreightGuarantee() {
     ...
     * is applied to the rate quote.
     */
    public void setFreightGuarantee(com.fedex.ws.rate.v9.FreightGuaranteeType freightGuarantee) {
        this.freightGuarantee = freightGuarantee;
    }
     ...
     * is a variable option on the rate request.
     */
    public com.fedex.ws.rate.v9.SmartPostIndiciaType getSmartPostIndicia() {
     ...
     * is a variable option on the rate request.
     */
    public void setSmartPostIndicia(com.fedex.ws.rate.v9.SmartPostIndiciaType smartPostIndicia) {
        this.smartPostIndicia = smartPostIndicia;
    }
