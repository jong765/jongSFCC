...
public class ShipmentRateDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.ReturnedRateType rateType;
    ...
    private com.fedex.ws.rate.v9.PricingCodeType pricingCode;

    /* Indicates which weight was used. */
    private com.fedex.ws.rate.v9.RatedWeightMethod ratedWeightMethod;

    /* INTERNAL FEDEX USE ONLY. */
    private com.fedex.ws.rate.v9.MinimumChargeType minimumChargeType;

    /* Specifies the currency exchange performed on financial amounts
     * for this rate. */
    private com.fedex.ws.rate.v9.CurrencyExchangeRate currencyExchangeRate;

    /* Indicates which special rating cases applied to this shipment. */
    private com.fedex.ws.rate.v9.SpecialRatingAppliedType[] specialRatingApplied;
    ...
    private com.fedex.ws.rate.v9.RateDimensionalDivisorType dimDivisorType;

    private java.math.BigDecimal fuelSurchargePercent;

    /* The weight used to calculate these rates. */
    private com.fedex.ws.rate.v9.Weight totalBillingWeight;

    /* Sum of dimensional weights for all packages. */
    private com.fedex.ws.rate.v9.Weight totalDimWeight;

    private com.fedex.ws.rate.v9.Money totalBaseCharge;

    /* The total discounts used in the rate calculation. */
    private com.fedex.ws.rate.v9.Money totalFreightDiscounts;

    /* The freight charge minus discounts. */
    private com.fedex.ws.rate.v9.Money totalNetFreight;

    /* The total amount of all surcharges applied to this shipment. */
    private com.fedex.ws.rate.v9.Money totalSurcharges;

    /* This shipment's totalNetFreight + totalSurcharges (not including
     * totalTaxes). */
    private com.fedex.ws.rate.v9.Money totalNetFedExCharge;

    /* Total of the transportation-based taxes. */
    private com.fedex.ws.rate.v9.Money totalTaxes;

    /* The net charge after applying all discounts and surcharges. */
    private com.fedex.ws.rate.v9.Money totalNetCharge;

    /* The total sum of all rebates applied to this shipment. */
    private com.fedex.ws.rate.v9.Money totalRebates;
    ...
    private com.fedex.ws.rate.v9.Money totalDutiesAndTaxes;
     ...
     * sender's account. */
    private com.fedex.ws.rate.v9.Money totalNetChargeWithDutiesAndTaxes;

    /* Rate data specific to FedEx Freight and FedEx National Freight
     * services. */
    private com.fedex.ws.rate.v9.FreightRateDetail freightRateDetail;

    /* All rate discounts that apply to this shipment. */
    private com.fedex.ws.rate.v9.RateDiscount[] freightDiscounts;

    /* All rebates that apply to this shipment. */
    private com.fedex.ws.rate.v9.Rebate[] rebates;

    /* All surcharges that apply to this shipment. */
    private com.fedex.ws.rate.v9.Surcharge[] surcharges;

    /* All transportation-based taxes applicable to this shipment. */
    private com.fedex.ws.rate.v9.Tax[] taxes;

    /* All commodity-based duties and taxes applicable to this shipment. */
    private com.fedex.ws.rate.v9.EdtCommodityTax[] dutiesAndTaxes;

    /* The "order level" variable handling charges. */
    private com.fedex.ws.rate.v9.VariableHandlingCharges variableHandlingCharges;

    /* The total of all variable handling charges at both shipment
     * (order) and package level. */
    private com.fedex.ws.rate.v9.VariableHandlingCharges totalVariableHandlingCharges;

    public ShipmentRateDetail() {
    }

    public ShipmentRateDetail(
           com.fedex.ws.rate.v9.ReturnedRateType rateType,
           java.lang.String rateScale,
           java.lang.String rateZone,
           com.fedex.ws.rate.v9.PricingCodeType pricingCode,
           com.fedex.ws.rate.v9.RatedWeightMethod ratedWeightMethod,
           com.fedex.ws.rate.v9.MinimumChargeType minimumChargeType,
           com.fedex.ws.rate.v9.CurrencyExchangeRate currencyExchangeRate,
           com.fedex.ws.rate.v9.SpecialRatingAppliedType[] specialRatingApplied,
           org.apache.axis.types.NonNegativeInteger dimDivisor,
           com.fedex.ws.rate.v9.RateDimensionalDivisorType dimDivisorType,
           java.math.BigDecimal fuelSurchargePercent,
           com.fedex.ws.rate.v9.Weight totalBillingWeight,
           com.fedex.ws.rate.v9.Weight totalDimWeight,
           com.fedex.ws.rate.v9.Money totalBaseCharge,
           com.fedex.ws.rate.v9.Money totalFreightDiscounts,
           com.fedex.ws.rate.v9.Money totalNetFreight,
           com.fedex.ws.rate.v9.Money totalSurcharges,
           com.fedex.ws.rate.v9.Money totalNetFedExCharge,
           com.fedex.ws.rate.v9.Money totalTaxes,
           com.fedex.ws.rate.v9.Money totalNetCharge,
           com.fedex.ws.rate.v9.Money totalRebates,
           com.fedex.ws.rate.v9.Money totalDutiesAndTaxes,
           com.fedex.ws.rate.v9.Money totalNetChargeWithDutiesAndTaxes,
           com.fedex.ws.rate.v9.FreightRateDetail freightRateDetail,
           com.fedex.ws.rate.v9.RateDiscount[] freightDiscounts,
           com.fedex.ws.rate.v9.Rebate[] rebates,
           com.fedex.ws.rate.v9.Surcharge[] surcharges,
           com.fedex.ws.rate.v9.Tax[] taxes,
           com.fedex.ws.rate.v9.EdtCommodityTax[] dutiesAndTaxes,
           com.fedex.ws.rate.v9.VariableHandlingCharges variableHandlingCharges,
           com.fedex.ws.rate.v9.VariableHandlingCharges totalVariableHandlingCharges) {
     ...
     */
    public com.fedex.ws.rate.v9.ReturnedRateType getRateType() {
        return rateType;
    }
     ...
     */
    public void setRateType(com.fedex.ws.rate.v9.ReturnedRateType rateType) {
        this.rateType = rateType;
    }
     ...
     */
    public com.fedex.ws.rate.v9.PricingCodeType getPricingCode() {
        return pricingCode;
    }
     ...
     */
    public void setPricingCode(com.fedex.ws.rate.v9.PricingCodeType pricingCode) {
        this.pricingCode = pricingCode;
    }
     ...
     */
    public com.fedex.ws.rate.v9.RatedWeightMethod getRatedWeightMethod() {
     ...
     */
    public void setRatedWeightMethod(com.fedex.ws.rate.v9.RatedWeightMethod ratedWeightMethod) {
        this.ratedWeightMethod = ratedWeightMethod;
    }
     ...
     */
    public com.fedex.ws.rate.v9.MinimumChargeType getMinimumChargeType() {
     ...
     */
    public void setMinimumChargeType(com.fedex.ws.rate.v9.MinimumChargeType minimumChargeType) {
        this.minimumChargeType = minimumChargeType;
    }
     ...
     * for this rate.
     */
    public com.fedex.ws.rate.v9.CurrencyExchangeRate getCurrencyExchangeRate() {
     ...
     * for this rate.
     */
    public void setCurrencyExchangeRate(com.fedex.ws.rate.v9.CurrencyExchangeRate currencyExchangeRate) {
        this.currencyExchangeRate = currencyExchangeRate;
    }
     ...
     */
    public com.fedex.ws.rate.v9.SpecialRatingAppliedType[] getSpecialRatingApplied() {
     ...
     */
    public void setSpecialRatingApplied(com.fedex.ws.rate.v9.SpecialRatingAppliedType[] specialRatingApplied) {
        this.specialRatingApplied = specialRatingApplied;
    }

    public com.fedex.ws.rate.v9.SpecialRatingAppliedType getSpecialRatingApplied(int i) {
        return this.specialRatingApplied[i];
    }

    public void setSpecialRatingApplied(int i, com.fedex.ws.rate.v9.SpecialRatingAppliedType _value) {
     ...
     */
    public com.fedex.ws.rate.v9.RateDimensionalDivisorType getDimDivisorType() {
     ...
     */
    public void setDimDivisorType(com.fedex.ws.rate.v9.RateDimensionalDivisorType dimDivisorType) {
        this.dimDivisorType = dimDivisorType;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Weight getTotalBillingWeight() {
     ...
     */
    public void setTotalBillingWeight(com.fedex.ws.rate.v9.Weight totalBillingWeight) {
        this.totalBillingWeight = totalBillingWeight;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Weight getTotalDimWeight() {
     ...
     */
    public void setTotalDimWeight(com.fedex.ws.rate.v9.Weight totalDimWeight) {
        this.totalDimWeight = totalDimWeight;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Money getTotalBaseCharge() {
        return totalBaseCharge;
    }
     ...
     */
    public void setTotalBaseCharge(com.fedex.ws.rate.v9.Money totalBaseCharge) {
        this.totalBaseCharge = totalBaseCharge;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Money getTotalFreightDiscounts() {
     ...
     */
    public void setTotalFreightDiscounts(com.fedex.ws.rate.v9.Money totalFreightDiscounts) {
        this.totalFreightDiscounts = totalFreightDiscounts;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Money getTotalNetFreight() {
     ...
     */
    public void setTotalNetFreight(com.fedex.ws.rate.v9.Money totalNetFreight) {
        this.totalNetFreight = totalNetFreight;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Money getTotalSurcharges() {
     ...
     */
    public void setTotalSurcharges(com.fedex.ws.rate.v9.Money totalSurcharges) {
        this.totalSurcharges = totalSurcharges;
    }
     ...
     * totalTaxes).
     */
    public com.fedex.ws.rate.v9.Money getTotalNetFedExCharge() {
     ...
     * totalTaxes).
     */
    public void setTotalNetFedExCharge(com.fedex.ws.rate.v9.Money totalNetFedExCharge) {
        this.totalNetFedExCharge = totalNetFedExCharge;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Money getTotalTaxes() {
        return totalTaxes;
    }
     ...
     */
    public void setTotalTaxes(com.fedex.ws.rate.v9.Money totalTaxes) {
        this.totalTaxes = totalTaxes;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Money getTotalNetCharge() {
     ...
     */
    public void setTotalNetCharge(com.fedex.ws.rate.v9.Money totalNetCharge) {
        this.totalNetCharge = totalNetCharge;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Money getTotalRebates() {
        return totalRebates;
    }
     ...
     */
    public void setTotalRebates(com.fedex.ws.rate.v9.Money totalRebates) {
        this.totalRebates = totalRebates;
    }
     ...
     * provided if estimated duties and taxes were calculated for this shipment.
     */
    public com.fedex.ws.rate.v9.Money getTotalDutiesAndTaxes() {
     ...
     * provided if estimated duties and taxes were calculated for this shipment.
     */
    public void setTotalDutiesAndTaxes(com.fedex.ws.rate.v9.Money totalDutiesAndTaxes) {
        this.totalDutiesAndTaxes = totalDutiesAndTaxes;
    }
     ...
     * sender's account.
     */
    public com.fedex.ws.rate.v9.Money getTotalNetChargeWithDutiesAndTaxes() {
     ...
     * sender's account.
     */
    public void setTotalNetChargeWithDutiesAndTaxes(com.fedex.ws.rate.v9.Money totalNetChargeWithDutiesAndTaxes) {
        this.totalNetChargeWithDutiesAndTaxes = totalNetChargeWithDutiesAndTaxes;
    }
     ...
     * services.
     */
    public com.fedex.ws.rate.v9.FreightRateDetail getFreightRateDetail() {
     ...
     * services.
     */
    public void setFreightRateDetail(com.fedex.ws.rate.v9.FreightRateDetail freightRateDetail) {
        this.freightRateDetail = freightRateDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.RateDiscount[] getFreightDiscounts() {
     ...
     */
    public void setFreightDiscounts(com.fedex.ws.rate.v9.RateDiscount[] freightDiscounts) {
        this.freightDiscounts = freightDiscounts;
    }

    public com.fedex.ws.rate.v9.RateDiscount getFreightDiscounts(int i) {
        return this.freightDiscounts[i];
    }

    public void setFreightDiscounts(int i, com.fedex.ws.rate.v9.RateDiscount _value) {
     ...
     */
    public com.fedex.ws.rate.v9.Rebate[] getRebates() {
        return rebates;
    }
     ...
     */
    public void setRebates(com.fedex.ws.rate.v9.Rebate[] rebates) {
        this.rebates = rebates;
    }

    public com.fedex.ws.rate.v9.Rebate getRebates(int i) {
        return this.rebates[i];
    }

    public void setRebates(int i, com.fedex.ws.rate.v9.Rebate _value) {
     ...
     */
    public com.fedex.ws.rate.v9.Surcharge[] getSurcharges() {
        return surcharges;
    }
     ...
     */
    public void setSurcharges(com.fedex.ws.rate.v9.Surcharge[] surcharges) {
        this.surcharges = surcharges;
    }

    public com.fedex.ws.rate.v9.Surcharge getSurcharges(int i) {
        return this.surcharges[i];
    }

    public void setSurcharges(int i, com.fedex.ws.rate.v9.Surcharge _value) {
     ...
     */
    public com.fedex.ws.rate.v9.Tax[] getTaxes() {
        return taxes;
    }
     ...
     */
    public void setTaxes(com.fedex.ws.rate.v9.Tax[] taxes) {
        this.taxes = taxes;
    }

    public com.fedex.ws.rate.v9.Tax getTaxes(int i) {
        return this.taxes[i];
    }

    public void setTaxes(int i, com.fedex.ws.rate.v9.Tax _value) {
        this.taxes[i] = _value;
    }
     ...
     */
    public com.fedex.ws.rate.v9.EdtCommodityTax[] getDutiesAndTaxes() {
     ...
     */
    public void setDutiesAndTaxes(com.fedex.ws.rate.v9.EdtCommodityTax[] dutiesAndTaxes) {
        this.dutiesAndTaxes = dutiesAndTaxes;
    }

    public com.fedex.ws.rate.v9.EdtCommodityTax getDutiesAndTaxes(int i) {
        return this.dutiesAndTaxes[i];
    }

    public void setDutiesAndTaxes(int i, com.fedex.ws.rate.v9.EdtCommodityTax _value) {
     ...
     */
    public com.fedex.ws.rate.v9.VariableHandlingCharges getVariableHandlingCharges() {
     ...
     */
    public void setVariableHandlingCharges(com.fedex.ws.rate.v9.VariableHandlingCharges variableHandlingCharges) {
        this.variableHandlingCharges = variableHandlingCharges;
    }
     ...
     * (order) and package level.
     */
    public com.fedex.ws.rate.v9.VariableHandlingCharges getTotalVariableHandlingCharges() {
     ...
     * (order) and package level.
     */
    public void setTotalVariableHandlingCharges(com.fedex.ws.rate.v9.VariableHandlingCharges totalVariableHandlingCharges) {
        this.totalVariableHandlingCharges = totalVariableHandlingCharges;
    }
