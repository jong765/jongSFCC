...
public class RateRequest  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.WebAuthenticationDetail webAuthenticationDetail;

    /* Descriptive data identifying the client submitting the transaction. */
    private com.fedex.ws.rate.v9.ClientDetail clientDetail;
     ...
     * reply. */
    private com.fedex.ws.rate.v9.TransactionDetail transactionDetail;
     ...
     * reply). */
    private com.fedex.ws.rate.v9.VersionId version;
    ...
    private com.fedex.ws.rate.v9.CarrierCodeType[] carrierCodes;

    /* Contains zero or more service options whose combinations are
     * to be considered when replying with available services. */
    private com.fedex.ws.rate.v9.ServiceOptionType[] variableOptions;

    /* The shipment for which a rate quote (or rate-shopping comparison)
     * is desired. */
    private com.fedex.ws.rate.v9.RequestedShipment requestedShipment;

    public RateRequest() {
    }

    public RateRequest(
           com.fedex.ws.rate.v9.WebAuthenticationDetail webAuthenticationDetail,
           com.fedex.ws.rate.v9.ClientDetail clientDetail,
           com.fedex.ws.rate.v9.TransactionDetail transactionDetail,
           com.fedex.ws.rate.v9.VersionId version,
           java.lang.Boolean returnTransitAndCommit,
           com.fedex.ws.rate.v9.CarrierCodeType[] carrierCodes,
           com.fedex.ws.rate.v9.ServiceOptionType[] variableOptions,
           com.fedex.ws.rate.v9.RequestedShipment requestedShipment) {
     ...
     * identity (and right to use FedEx web services).
     */
    public com.fedex.ws.rate.v9.WebAuthenticationDetail getWebAuthenticationDetail() {
     ...
     * identity (and right to use FedEx web services).
     */
    public void setWebAuthenticationDetail(com.fedex.ws.rate.v9.WebAuthenticationDetail webAuthenticationDetail) {
        this.webAuthenticationDetail = webAuthenticationDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.ClientDetail getClientDetail() {
        return clientDetail;
    }
     ...
     */
    public void setClientDetail(com.fedex.ws.rate.v9.ClientDetail clientDetail) {
        this.clientDetail = clientDetail;
    }
     ...
     * reply.
     */
    public com.fedex.ws.rate.v9.TransactionDetail getTransactionDetail() {
     ...
     * reply.
     */
    public void setTransactionDetail(com.fedex.ws.rate.v9.TransactionDetail transactionDetail) {
        this.transactionDetail = transactionDetail;
    }
     ...
     * reply).
     */
    public com.fedex.ws.rate.v9.VersionId getVersion() {
        return version;
    }
     ...
     * reply).
     */
    public void setVersion(com.fedex.ws.rate.v9.VersionId version) {
        this.version = version;
    }
     ...
     * only considered if requestedShipment/serviceType is omitted.
     */
    public com.fedex.ws.rate.v9.CarrierCodeType[] getCarrierCodes() {
        return carrierCodes;
    }
     ...
     * only considered if requestedShipment/serviceType is omitted.
     */
    public void setCarrierCodes(com.fedex.ws.rate.v9.CarrierCodeType[] carrierCodes) {
        this.carrierCodes = carrierCodes;
    }

    public com.fedex.ws.rate.v9.CarrierCodeType getCarrierCodes(int i) {
        return this.carrierCodes[i];
    }

    public void setCarrierCodes(int i, com.fedex.ws.rate.v9.CarrierCodeType _value) {
     ...
     * to be considered when replying with available services.
     */
    public com.fedex.ws.rate.v9.ServiceOptionType[] getVariableOptions() {
     ...
     * to be considered when replying with available services.
     */
    public void setVariableOptions(com.fedex.ws.rate.v9.ServiceOptionType[] variableOptions) {
        this.variableOptions = variableOptions;
    }

    public com.fedex.ws.rate.v9.ServiceOptionType getVariableOptions(int i) {
        return this.variableOptions[i];
    }

    public void setVariableOptions(int i, com.fedex.ws.rate.v9.ServiceOptionType _value) {
     ...
     * is desired.
     */
    public com.fedex.ws.rate.v9.RequestedShipment getRequestedShipment() {
     ...
     * is desired.
     */
    public void setRequestedShipment(com.fedex.ws.rate.v9.RequestedShipment requestedShipment) {
        this.requestedShipment = requestedShipment;
    }
