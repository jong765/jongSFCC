...
public class HazardousCommodityContent  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.HazardousCommodityDescription description;

    /* Specifies the amount of the commodity in alternate units. */
    private com.fedex.ws.rate.v9.HazardousCommodityQuantityDetail quantity;

    /* Customer-provided specifications for handling individual commodities. */
    private com.fedex.ws.rate.v9.HazardousCommodityOptionDetail options;

    public HazardousCommodityContent() {
    }

    public HazardousCommodityContent(
           com.fedex.ws.rate.v9.HazardousCommodityDescription description,
           com.fedex.ws.rate.v9.HazardousCommodityQuantityDetail quantity,
           com.fedex.ws.rate.v9.HazardousCommodityOptionDetail options) {
     ...
     */
    public com.fedex.ws.rate.v9.HazardousCommodityDescription getDescription() {
        return description;
    }
     ...
     */
    public void setDescription(com.fedex.ws.rate.v9.HazardousCommodityDescription description) {
        this.description = description;
    }
     ...
     */
    public com.fedex.ws.rate.v9.HazardousCommodityQuantityDetail getQuantity() {
        return quantity;
    }
     ...
     */
    public void setQuantity(com.fedex.ws.rate.v9.HazardousCommodityQuantityDetail quantity) {
        this.quantity = quantity;
    }
     ...
     */
    public com.fedex.ws.rate.v9.HazardousCommodityOptionDetail getOptions() {
        return options;
    }
     ...
     */
    public void setOptions(com.fedex.ws.rate.v9.HazardousCommodityOptionDetail options) {
        this.options = options;
    }
