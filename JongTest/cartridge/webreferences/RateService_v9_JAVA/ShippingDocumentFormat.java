...
public class ShippingDocumentFormat  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.ShippingDocumentDispositionDetail[] dispositions;
    ...
    private com.fedex.ws.rate.v9.LinearMeasure topOfPageOffset;

    private com.fedex.ws.rate.v9.ShippingDocumentImageType imageType;

    private com.fedex.ws.rate.v9.ShippingDocumentStockType stockType;
    ...
    private com.fedex.ws.rate.v9.Localization localization;

    public ShippingDocumentFormat() {
    }

    public ShippingDocumentFormat(
           com.fedex.ws.rate.v9.ShippingDocumentDispositionDetail[] dispositions,
           com.fedex.ws.rate.v9.LinearMeasure topOfPageOffset,
           com.fedex.ws.rate.v9.ShippingDocumentImageType imageType,
           com.fedex.ws.rate.v9.ShippingDocumentStockType stockType,
           java.lang.Boolean provideInstructions,
           com.fedex.ws.rate.v9.Localization localization) {
     ...
     */
    public com.fedex.ws.rate.v9.ShippingDocumentDispositionDetail[] getDispositions() {
        return dispositions;
    }
     ...
     */
    public void setDispositions(com.fedex.ws.rate.v9.ShippingDocumentDispositionDetail[] dispositions) {
        this.dispositions = dispositions;
    }

    public com.fedex.ws.rate.v9.ShippingDocumentDispositionDetail getDispositions(int i) {
        return this.dispositions[i];
    }

    public void setDispositions(int i, com.fedex.ws.rate.v9.ShippingDocumentDispositionDetail _value) {
     ...
     * image; allows for printing on letterhead and other pre-printed stock.
     */
    public com.fedex.ws.rate.v9.LinearMeasure getTopOfPageOffset() {
     ...
     * image; allows for printing on letterhead and other pre-printed stock.
     */
    public void setTopOfPageOffset(com.fedex.ws.rate.v9.LinearMeasure topOfPageOffset) {
        this.topOfPageOffset = topOfPageOffset;
    }
     ...
     * @return stockType
     */
    public com.fedex.ws.rate.v9.ShippingDocumentStockType getStockType() {
        return stockType;
    }
     ...
     * @param stockType
     */
    public void setStockType(com.fedex.ws.rate.v9.ShippingDocumentStockType stockType) {
        this.stockType = stockType;
    }
     ...
     * independently from other content returned for the same shipment.
     */
    public com.fedex.ws.rate.v9.Localization getLocalization() {
        return localization;
    }
     ...
     * independently from other content returned for the same shipment.
     */
    public void setLocalization(com.fedex.ws.rate.v9.Localization localization) {
        this.localization = localization;
    }
