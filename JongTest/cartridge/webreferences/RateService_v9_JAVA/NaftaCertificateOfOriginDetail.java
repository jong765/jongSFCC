...
public class NaftaCertificateOfOriginDetail  implements java.io.Serializable {
    private com.fedex.ws.rate.v9.ShippingDocumentFormat format;

    private com.fedex.ws.rate.v9.DateRange blanketPeriod;

    /* Indicates which Party (if any) from the shipment is to be used
     * as the source of importer data on the NAFTA COO form. */
    private com.fedex.ws.rate.v9.NaftaImporterSpecificationType importerSpecification;

    /* Contact information for "Authorized Signature" area of form. */
    private com.fedex.ws.rate.v9.Contact signatureContact;

    private com.fedex.ws.rate.v9.NaftaProducerSpecificationType producerSpecification;

    private com.fedex.ws.rate.v9.NaftaProducer[] producers;

    private com.fedex.ws.rate.v9.CustomerImageUsage[] customerImageUsages;

    public NaftaCertificateOfOriginDetail() {
    }

    public NaftaCertificateOfOriginDetail(
           com.fedex.ws.rate.v9.ShippingDocumentFormat format,
           com.fedex.ws.rate.v9.DateRange blanketPeriod,
           com.fedex.ws.rate.v9.NaftaImporterSpecificationType importerSpecification,
           com.fedex.ws.rate.v9.Contact signatureContact,
           com.fedex.ws.rate.v9.NaftaProducerSpecificationType producerSpecification,
           com.fedex.ws.rate.v9.NaftaProducer[] producers,
           com.fedex.ws.rate.v9.CustomerImageUsage[] customerImageUsages) {
           this.format = format;
     ...
     * @return format
     */
    public com.fedex.ws.rate.v9.ShippingDocumentFormat getFormat() {
        return format;
    }
     ...
     * @param format
     */
    public void setFormat(com.fedex.ws.rate.v9.ShippingDocumentFormat format) {
        this.format = format;
    }
     ...
     */
    public com.fedex.ws.rate.v9.DateRange getBlanketPeriod() {
        return blanketPeriod;
    }
     ...
     * @param blanketPeriod
     */
    public void setBlanketPeriod(com.fedex.ws.rate.v9.DateRange blanketPeriod) {
        this.blanketPeriod = blanketPeriod;
    }
     ...
     * as the source of importer data on the NAFTA COO form.
     */
    public com.fedex.ws.rate.v9.NaftaImporterSpecificationType getImporterSpecification() {
     ...
     * as the source of importer data on the NAFTA COO form.
     */
    public void setImporterSpecification(com.fedex.ws.rate.v9.NaftaImporterSpecificationType importerSpecification) {
        this.importerSpecification = importerSpecification;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Contact getSignatureContact() {
     ...
     */
    public void setSignatureContact(com.fedex.ws.rate.v9.Contact signatureContact) {
        this.signatureContact = signatureContact;
    }
     ...
     */
    public com.fedex.ws.rate.v9.NaftaProducerSpecificationType getProducerSpecification() {
        return producerSpecification;
    }
     ...
     */
    public void setProducerSpecification(com.fedex.ws.rate.v9.NaftaProducerSpecificationType producerSpecification) {
        this.producerSpecification = producerSpecification;
    }
     ...
     * @return producers
     */
    public com.fedex.ws.rate.v9.NaftaProducer[] getProducers() {
        return producers;
    }
     ...
     * @param producers
     */
    public void setProducers(com.fedex.ws.rate.v9.NaftaProducer[] producers) {
        this.producers = producers;
    }

    public com.fedex.ws.rate.v9.NaftaProducer getProducers(int i) {
        return this.producers[i];
    }

    public void setProducers(int i, com.fedex.ws.rate.v9.NaftaProducer _value) {
     ...
     */
    public com.fedex.ws.rate.v9.CustomerImageUsage[] getCustomerImageUsages() {
        return customerImageUsages;
    }
     ...
     */
    public void setCustomerImageUsages(com.fedex.ws.rate.v9.CustomerImageUsage[] customerImageUsages) {
        this.customerImageUsages = customerImageUsages;
    }

    public com.fedex.ws.rate.v9.CustomerImageUsage getCustomerImageUsages(int i) {
        return this.customerImageUsages[i];
    }

    public void setCustomerImageUsages(int i, com.fedex.ws.rate.v9.CustomerImageUsage _value) {
