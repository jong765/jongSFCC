...
public class CommitDetail  implements java.io.Serializable {
     ...
     * to the caller. */
    private com.fedex.ws.rate.v9.ServiceOptionType[] appliedOptions;

    /* Supporting detail for applied options identified in preceding
     * field. */
    private com.fedex.ws.rate.v9.ServiceSubOptionDetail appliedSubOptions;
    ...
    private com.fedex.ws.rate.v9.DayOfWeekType dayOfWeek;

    /* The number of transit days; applies to Ground and LTL Freight;
     * indicates minimum transit time for SmartPost. */
    private com.fedex.ws.rate.v9.TransitTimeType transitTime;

    /* Maximum number of transit days, for SmartPost shipments. */
    private com.fedex.ws.rate.v9.TransitTimeType maximumTransitTime;
    ...
    private com.fedex.ws.rate.v9.Address brokerAddress;
     ...
     * at the border. */
    private com.fedex.ws.rate.v9.DayOfWeekType brokerCommitDayOfWeek;
    ...
    private com.fedex.ws.rate.v9.DayOfWeekType proofOfDeliveryDayOfWeek;
    ...
    private com.fedex.ws.rate.v9.Notification[] commitMessages;
    ...
    private com.fedex.ws.rate.v9.DelayDetail[] delayDetails;

    private com.fedex.ws.rate.v9.InternationalDocumentContentType documentContent;

    /* Required documentation for this shipment. */
    private com.fedex.ws.rate.v9.RequiredShippingDocumentType[] requiredDocuments;

    /* Freight origin and destination city center information and
     * total distance between origin and destination city centers. */
    private com.fedex.ws.rate.v9.FreightCommitDetail freightCommitDetail;
    ...
    public CommitDetail(
           ...
           com.fedex.ws.rate.v9.ServiceOptionType[] appliedOptions,
           com.fedex.ws.rate.v9.ServiceSubOptionDetail appliedSubOptions,
           java.util.Calendar commitTimestamp,
           com.fedex.ws.rate.v9.DayOfWeekType dayOfWeek,
           com.fedex.ws.rate.v9.TransitTimeType transitTime,
           com.fedex.ws.rate.v9.TransitTimeType maximumTransitTime,
           java.lang.String destinationServiceArea,
           com.fedex.ws.rate.v9.Address brokerAddress,
           java.lang.String brokerLocationId,
           java.util.Calendar brokerCommitTimestamp,
           com.fedex.ws.rate.v9.DayOfWeekType brokerCommitDayOfWeek,
           org.apache.axis.types.NonNegativeInteger brokerToDestinationDays,
           java.util.Date proofOfDeliveryDate,
           com.fedex.ws.rate.v9.DayOfWeekType proofOfDeliveryDayOfWeek,
           com.fedex.ws.rate.v9.Notification[] commitMessages,
           java.lang.String[] deliveryMessages,
           com.fedex.ws.rate.v9.DelayDetail[] delayDetails,
           com.fedex.ws.rate.v9.InternationalDocumentContentType documentContent,
           com.fedex.ws.rate.v9.RequiredShippingDocumentType[] requiredDocuments,
           com.fedex.ws.rate.v9.FreightCommitDetail freightCommitDetail) {
     ...
     * to the caller.
     */
    public com.fedex.ws.rate.v9.ServiceOptionType[] getAppliedOptions() {
     ...
     * to the caller.
     */
    public void setAppliedOptions(com.fedex.ws.rate.v9.ServiceOptionType[] appliedOptions) {
        this.appliedOptions = appliedOptions;
    }

    public com.fedex.ws.rate.v9.ServiceOptionType getAppliedOptions(int i) {
        return this.appliedOptions[i];
    }

    public void setAppliedOptions(int i, com.fedex.ws.rate.v9.ServiceOptionType _value) {
     ...
     * field.
     */
    public com.fedex.ws.rate.v9.ServiceSubOptionDetail getAppliedSubOptions() {
     ...
     * field.
     */
    public void setAppliedSubOptions(com.fedex.ws.rate.v9.ServiceSubOptionDetail appliedSubOptions) {
        this.appliedSubOptions = appliedSubOptions;
    }
     ...
     */
    public com.fedex.ws.rate.v9.DayOfWeekType getDayOfWeek() {
        return dayOfWeek;
    }
     ...
     */
    public void setDayOfWeek(com.fedex.ws.rate.v9.DayOfWeekType dayOfWeek) {
        this.dayOfWeek = dayOfWeek;
    }
     ...
     * indicates minimum transit time for SmartPost.
     */
    public com.fedex.ws.rate.v9.TransitTimeType getTransitTime() {
        return transitTime;
    }
     ...
     * indicates minimum transit time for SmartPost.
     */
    public void setTransitTime(com.fedex.ws.rate.v9.TransitTimeType transitTime) {
        this.transitTime = transitTime;
    }
     ...
     */
    public com.fedex.ws.rate.v9.TransitTimeType getMaximumTransitTime() {
     ...
     */
    public void setMaximumTransitTime(com.fedex.ws.rate.v9.TransitTimeType maximumTransitTime) {
        this.maximumTransitTime = maximumTransitTime;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Address getBrokerAddress() {
     ...
     */
    public void setBrokerAddress(com.fedex.ws.rate.v9.Address brokerAddress) {
        this.brokerAddress = brokerAddress;
    }
     ...
     * at the border.
     */
    public com.fedex.ws.rate.v9.DayOfWeekType getBrokerCommitDayOfWeek() {
     ...
     * at the border.
     */
    public void setBrokerCommitDayOfWeek(com.fedex.ws.rate.v9.DayOfWeekType brokerCommitDayOfWeek) {
        this.brokerCommitDayOfWeek = brokerCommitDayOfWeek;
    }
     ...
     * by GSP (Global Service Provider)
     */
    public com.fedex.ws.rate.v9.DayOfWeekType getProofOfDeliveryDayOfWeek() {
     ...
     * by GSP (Global Service Provider)
     */
    public void setProofOfDeliveryDayOfWeek(com.fedex.ws.rate.v9.DayOfWeekType proofOfDeliveryDayOfWeek) {
        this.proofOfDeliveryDayOfWeek = proofOfDeliveryDayOfWeek;
    }
     ...
     * or a successful message such as "REQUEST COMPLETED"
     */
    public com.fedex.ws.rate.v9.Notification[] getCommitMessages() {
     ...
     * or a successful message such as "REQUEST COMPLETED"
     */
    public void setCommitMessages(com.fedex.ws.rate.v9.Notification[] commitMessages) {
        this.commitMessages = commitMessages;
    }

    public com.fedex.ws.rate.v9.Notification getCommitMessages(int i) {
        return this.commitMessages[i];
    }

    public void setCommitMessages(int i, com.fedex.ws.rate.v9.Notification _value) {
     ...
     * what level (country/service etc.).
     */
    public com.fedex.ws.rate.v9.DelayDetail[] getDelayDetails() {
        return delayDetails;
    }
     ...
     * what level (country/service etc.).
     */
    public void setDelayDetails(com.fedex.ws.rate.v9.DelayDetail[] delayDetails) {
        this.delayDetails = delayDetails;
    }

    public com.fedex.ws.rate.v9.DelayDetail getDelayDetails(int i) {
        return this.delayDetails[i];
    }

    public void setDelayDetails(int i, com.fedex.ws.rate.v9.DelayDetail _value) {
     ...
     */
    public com.fedex.ws.rate.v9.InternationalDocumentContentType getDocumentContent() {
        return documentContent;
    }
     ...
     */
    public void setDocumentContent(com.fedex.ws.rate.v9.InternationalDocumentContentType documentContent) {
        this.documentContent = documentContent;
    }
     ...
     */
    public com.fedex.ws.rate.v9.RequiredShippingDocumentType[] getRequiredDocuments() {
     ...
     */
    public void setRequiredDocuments(com.fedex.ws.rate.v9.RequiredShippingDocumentType[] requiredDocuments) {
        this.requiredDocuments = requiredDocuments;
    }

    public com.fedex.ws.rate.v9.RequiredShippingDocumentType getRequiredDocuments(int i) {
        return this.requiredDocuments[i];
    }

    public void setRequiredDocuments(int i, com.fedex.ws.rate.v9.RequiredShippingDocumentType _value) {
     ...
     * total distance between origin and destination city centers.
     */
    public com.fedex.ws.rate.v9.FreightCommitDetail getFreightCommitDetail() {
     ...
     * total distance between origin and destination city centers.
     */
    public void setFreightCommitDetail(com.fedex.ws.rate.v9.FreightCommitDetail freightCommitDetail) {
        this.freightCommitDetail = freightCommitDetail;
    }
