...
public class FreightCommitDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.FreightServiceCenterDetail originDetail;

    /* Information about the destination Freight Service Center. */
    private com.fedex.ws.rate.v9.FreightServiceCenterDetail destinationDetail;

    /* The distance between the origin and destination FreightService
     * Centers */
    private com.fedex.ws.rate.v9.Distance totalDistance;

    public FreightCommitDetail() {
    }

    public FreightCommitDetail(
           com.fedex.ws.rate.v9.FreightServiceCenterDetail originDetail,
           com.fedex.ws.rate.v9.FreightServiceCenterDetail destinationDetail,
           com.fedex.ws.rate.v9.Distance totalDistance) {
     ...
     */
    public com.fedex.ws.rate.v9.FreightServiceCenterDetail getOriginDetail() {
        return originDetail;
    }
     ...
     */
    public void setOriginDetail(com.fedex.ws.rate.v9.FreightServiceCenterDetail originDetail) {
        this.originDetail = originDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.FreightServiceCenterDetail getDestinationDetail() {
     ...
     */
    public void setDestinationDetail(com.fedex.ws.rate.v9.FreightServiceCenterDetail destinationDetail) {
        this.destinationDetail = destinationDetail;
    }
     ...
     * Centers
     */
    public com.fedex.ws.rate.v9.Distance getTotalDistance() {
     ...
     * Centers
     */
    public void setTotalDistance(com.fedex.ws.rate.v9.Distance totalDistance) {
        this.totalDistance = totalDistance;
    }
