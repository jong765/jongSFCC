...
public class CustomLabelDetail  implements java.io.Serializable {
    private com.fedex.ws.rate.v9.CustomLabelCoordinateUnits coordinateUnits;

    private com.fedex.ws.rate.v9.CustomLabelTextEntry[] textEntries;

    private com.fedex.ws.rate.v9.CustomLabelGraphicEntry[] graphicEntries;

    private com.fedex.ws.rate.v9.CustomLabelBoxEntry[] boxEntries;

    private com.fedex.ws.rate.v9.CustomLabelBarcodeEntry[] barcodeEntries;

    public CustomLabelDetail() {
    }

    public CustomLabelDetail(
           com.fedex.ws.rate.v9.CustomLabelCoordinateUnits coordinateUnits,
           com.fedex.ws.rate.v9.CustomLabelTextEntry[] textEntries,
           com.fedex.ws.rate.v9.CustomLabelGraphicEntry[] graphicEntries,
           com.fedex.ws.rate.v9.CustomLabelBoxEntry[] boxEntries,
           com.fedex.ws.rate.v9.CustomLabelBarcodeEntry[] barcodeEntries) {
     ...
     */
    public com.fedex.ws.rate.v9.CustomLabelCoordinateUnits getCoordinateUnits() {
        return coordinateUnits;
    }
     ...
     */
    public void setCoordinateUnits(com.fedex.ws.rate.v9.CustomLabelCoordinateUnits coordinateUnits) {
        this.coordinateUnits = coordinateUnits;
    }
     ...
     * @return textEntries
     */
    public com.fedex.ws.rate.v9.CustomLabelTextEntry[] getTextEntries() {
        return textEntries;
    }
     ...
     * @param textEntries
     */
    public void setTextEntries(com.fedex.ws.rate.v9.CustomLabelTextEntry[] textEntries) {
        this.textEntries = textEntries;
    }

    public com.fedex.ws.rate.v9.CustomLabelTextEntry getTextEntries(int i) {
        return this.textEntries[i];
    }

    public void setTextEntries(int i, com.fedex.ws.rate.v9.CustomLabelTextEntry _value) {
     ...
     */
    public com.fedex.ws.rate.v9.CustomLabelGraphicEntry[] getGraphicEntries() {
        return graphicEntries;
    }
     ...
     */
    public void setGraphicEntries(com.fedex.ws.rate.v9.CustomLabelGraphicEntry[] graphicEntries) {
        this.graphicEntries = graphicEntries;
    }

    public com.fedex.ws.rate.v9.CustomLabelGraphicEntry getGraphicEntries(int i) {
        return this.graphicEntries[i];
    }

    public void setGraphicEntries(int i, com.fedex.ws.rate.v9.CustomLabelGraphicEntry _value) {
     ...
     * @return boxEntries
     */
    public com.fedex.ws.rate.v9.CustomLabelBoxEntry[] getBoxEntries() {
        return boxEntries;
    }
     ...
     * @param boxEntries
     */
    public void setBoxEntries(com.fedex.ws.rate.v9.CustomLabelBoxEntry[] boxEntries) {
        this.boxEntries = boxEntries;
    }

    public com.fedex.ws.rate.v9.CustomLabelBoxEntry getBoxEntries(int i) {
        return this.boxEntries[i];
    }

    public void setBoxEntries(int i, com.fedex.ws.rate.v9.CustomLabelBoxEntry _value) {
     ...
     */
    public com.fedex.ws.rate.v9.CustomLabelBarcodeEntry[] getBarcodeEntries() {
        return barcodeEntries;
    }
     ...
     */
    public void setBarcodeEntries(com.fedex.ws.rate.v9.CustomLabelBarcodeEntry[] barcodeEntries) {
        this.barcodeEntries = barcodeEntries;
    }

    public com.fedex.ws.rate.v9.CustomLabelBarcodeEntry getBarcodeEntries(int i) {
        return this.barcodeEntries[i];
    }

    public void setBarcodeEntries(int i, com.fedex.ws.rate.v9.CustomLabelBarcodeEntry _value) {
