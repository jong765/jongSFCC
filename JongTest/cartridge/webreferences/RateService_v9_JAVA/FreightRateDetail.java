...
public class FreightRateDetail  implements java.io.Serializable {
     ...
     * are calculated. */
    private com.fedex.ws.rate.v9.FreightBaseChargeCalculationType baseChargeCalculation;

    /* Freight charges which accumulate to the total base charge for
     * the shipment. */
    private com.fedex.ws.rate.v9.FreightBaseCharge[] baseCharges;

    /* Human-readable descriptions of additional information on this
     * shipment rating. */
    private com.fedex.ws.rate.v9.FreightRateNotation[] notations;
    ...
    public FreightRateDetail(
           ...
           com.fedex.ws.rate.v9.FreightBaseChargeCalculationType baseChargeCalculation,
           com.fedex.ws.rate.v9.FreightBaseCharge[] baseCharges,
           com.fedex.ws.rate.v9.FreightRateNotation[] notations) {
     ...
     * are calculated.
     */
    public com.fedex.ws.rate.v9.FreightBaseChargeCalculationType getBaseChargeCalculation() {
     ...
     * are calculated.
     */
    public void setBaseChargeCalculation(com.fedex.ws.rate.v9.FreightBaseChargeCalculationType baseChargeCalculation) {
        this.baseChargeCalculation = baseChargeCalculation;
    }
     ...
     * the shipment.
     */
    public com.fedex.ws.rate.v9.FreightBaseCharge[] getBaseCharges() {
        return baseCharges;
    }
     ...
     * the shipment.
     */
    public void setBaseCharges(com.fedex.ws.rate.v9.FreightBaseCharge[] baseCharges) {
        this.baseCharges = baseCharges;
    }

    public com.fedex.ws.rate.v9.FreightBaseCharge getBaseCharges(int i) {
        return this.baseCharges[i];
    }

    public void setBaseCharges(int i, com.fedex.ws.rate.v9.FreightBaseCharge _value) {
     ...
     * shipment rating.
     */
    public com.fedex.ws.rate.v9.FreightRateNotation[] getNotations() {
        return notations;
    }
     ...
     * shipment rating.
     */
    public void setNotations(com.fedex.ws.rate.v9.FreightRateNotation[] notations) {
        this.notations = notations;
    }

    public com.fedex.ws.rate.v9.FreightRateNotation getNotations(int i) {
        return this.notations[i];
    }

    public void setNotations(int i, com.fedex.ws.rate.v9.FreightRateNotation _value) {
