...
public class VariableHandlingCharges  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.Money variableHandlingCharge;

    /* The calculated varibale handling charge plus the net charge. */
    private com.fedex.ws.rate.v9.Money totalCustomerCharge;

    public VariableHandlingCharges() {
    }

    public VariableHandlingCharges(
           com.fedex.ws.rate.v9.Money variableHandlingCharge,
           com.fedex.ws.rate.v9.Money totalCustomerCharge) {
     ...
     * requested variable handling charge detail.
     */
    public com.fedex.ws.rate.v9.Money getVariableHandlingCharge() {
     ...
     * requested variable handling charge detail.
     */
    public void setVariableHandlingCharge(com.fedex.ws.rate.v9.Money variableHandlingCharge) {
        this.variableHandlingCharge = variableHandlingCharge;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Money getTotalCustomerCharge() {
     ...
     */
    public void setTotalCustomerCharge(com.fedex.ws.rate.v9.Money totalCustomerCharge) {
        this.totalCustomerCharge = totalCustomerCharge;
    }
