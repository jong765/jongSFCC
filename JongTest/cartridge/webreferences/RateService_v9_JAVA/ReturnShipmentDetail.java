...
public class ReturnShipmentDetail  implements java.io.Serializable {
     ...
     * label. */
    private com.fedex.ws.rate.v9.ReturnType returnType;

    /* Return Merchant Authorization */
    private com.fedex.ws.rate.v9.Rma rma;

    /* Specific information about the delivery of the email and options
     * for the shipment. */
    private com.fedex.ws.rate.v9.ReturnEMailDetail returnEMailDetail;

    public ReturnShipmentDetail() {
    }

    public ReturnShipmentDetail(
           com.fedex.ws.rate.v9.ReturnType returnType,
           com.fedex.ws.rate.v9.Rma rma,
           com.fedex.ws.rate.v9.ReturnEMailDetail returnEMailDetail) {
     ...
     * label.
     */
    public com.fedex.ws.rate.v9.ReturnType getReturnType() {
        return returnType;
    }
     ...
     * label.
     */
    public void setReturnType(com.fedex.ws.rate.v9.ReturnType returnType) {
        this.returnType = returnType;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Rma getRma() {
        return rma;
    }
     ...
     */
    public void setRma(com.fedex.ws.rate.v9.Rma rma) {
        this.rma = rma;
    }
     ...
     * for the shipment.
     */
    public com.fedex.ws.rate.v9.ReturnEMailDetail getReturnEMailDetail() {
     ...
     * for the shipment.
     */
    public void setReturnEMailDetail(com.fedex.ws.rate.v9.ReturnEMailDetail returnEMailDetail) {
        this.returnEMailDetail = returnEMailDetail;
    }
