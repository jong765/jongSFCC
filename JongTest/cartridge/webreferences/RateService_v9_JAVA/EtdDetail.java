...
public class EtdDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.RequestedShippingDocumentType[] requestedDocumentCopies;

    /* Currently not supported. */
    private com.fedex.ws.rate.v9.UploadDocumentDetail[] documents;

    private com.fedex.ws.rate.v9.UploadDocumentReferenceDetail[] documentReferences;

    public EtdDetail() {
    }

    public EtdDetail(
           com.fedex.ws.rate.v9.RequestedShippingDocumentType[] requestedDocumentCopies,
           com.fedex.ws.rate.v9.UploadDocumentDetail[] documents,
           com.fedex.ws.rate.v9.UploadDocumentReferenceDetail[] documentReferences) {
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public com.fedex.ws.rate.v9.RequestedShippingDocumentType[] getRequestedDocumentCopies() {
     ...
     * be copied back to the shipper in the shipment result data.
     */
    public void setRequestedDocumentCopies(com.fedex.ws.rate.v9.RequestedShippingDocumentType[] requestedDocumentCopies) {
        this.requestedDocumentCopies = requestedDocumentCopies;
    }

    public com.fedex.ws.rate.v9.RequestedShippingDocumentType getRequestedDocumentCopies(int i) {
        return this.requestedDocumentCopies[i];
    }

    public void setRequestedDocumentCopies(int i, com.fedex.ws.rate.v9.RequestedShippingDocumentType _value) {
     ...
     */
    public com.fedex.ws.rate.v9.UploadDocumentDetail[] getDocuments() {
        return documents;
    }
     ...
     */
    public void setDocuments(com.fedex.ws.rate.v9.UploadDocumentDetail[] documents) {
        this.documents = documents;
    }

    public com.fedex.ws.rate.v9.UploadDocumentDetail getDocuments(int i) {
        return this.documents[i];
    }

    public void setDocuments(int i, com.fedex.ws.rate.v9.UploadDocumentDetail _value) {
     ...
     */
    public com.fedex.ws.rate.v9.UploadDocumentReferenceDetail[] getDocumentReferences() {
        return documentReferences;
    }
     ...
     */
    public void setDocumentReferences(com.fedex.ws.rate.v9.UploadDocumentReferenceDetail[] documentReferences) {
        this.documentReferences = documentReferences;
    }

    public com.fedex.ws.rate.v9.UploadDocumentReferenceDetail getDocumentReferences(int i) {
        return this.documentReferences[i];
    }

    public void setDocumentReferences(int i, com.fedex.ws.rate.v9.UploadDocumentReferenceDetail _value) {
