...
public class RateReply  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.NotificationSeverityType highestSeverity;

    /* The descriptive data regarding the results of the submitted
     * transaction. */
    private com.fedex.ws.rate.v9.Notification[] notifications;
    ...
    private com.fedex.ws.rate.v9.RateReplyDetail[] rateReplyDetails;

    public RateReply() {
    }

    public RateReply(
           com.fedex.ws.rate.v9.NotificationSeverityType highestSeverity,
           com.fedex.ws.rate.v9.Notification[] notifications,
           com.fedex.ws.rate.v9.TransactionDetail transactionDetail,
           com.fedex.ws.rate.v9.VersionId version,
           com.fedex.ws.rate.v9.RateReplyDetail[] rateReplyDetails) {
     ...
     * returned in this reply.
     */
    public com.fedex.ws.rate.v9.NotificationSeverityType getHighestSeverity() {
     ...
     * returned in this reply.
     */
    public void setHighestSeverity(com.fedex.ws.rate.v9.NotificationSeverityType highestSeverity) {
        this.highestSeverity = highestSeverity;
    }
     ...
     * transaction.
     */
    public com.fedex.ws.rate.v9.Notification[] getNotifications() {
     ...
     * transaction.
     */
    public void setNotifications(com.fedex.ws.rate.v9.Notification[] notifications) {
        this.notifications = notifications;
    }

    public com.fedex.ws.rate.v9.Notification getNotifications(int i) {
        return this.notifications[i];
    }

    public void setNotifications(int i, com.fedex.ws.rate.v9.Notification _value) {
     ...
     * a separate entry in this array for each service being compared.
     */
    public com.fedex.ws.rate.v9.RateReplyDetail[] getRateReplyDetails() {
     ...
     * a separate entry in this array for each service being compared.
     */
    public void setRateReplyDetails(com.fedex.ws.rate.v9.RateReplyDetail[] rateReplyDetails) {
        this.rateReplyDetails = rateReplyDetails;
    }

    public com.fedex.ws.rate.v9.RateReplyDetail getRateReplyDetails(int i) {
        return this.rateReplyDetails[i];
    }

    public void setRateReplyDetails(int i, com.fedex.ws.rate.v9.RateReplyDetail _value) {
