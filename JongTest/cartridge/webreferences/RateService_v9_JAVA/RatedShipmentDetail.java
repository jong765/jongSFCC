...
public class RatedShipmentDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.ShipmentRateDetail shipmentRateDetail;

    /* The package-level data for this rate type. */
    private com.fedex.ws.rate.v9.RatedPackageDetail[] ratedPackages;
    ...
    public RatedShipmentDetail(
           ...
           com.fedex.ws.rate.v9.ShipmentRateDetail shipmentRateDetail,
           com.fedex.ws.rate.v9.RatedPackageDetail[] ratedPackages) {
     ...
     */
    public com.fedex.ws.rate.v9.ShipmentRateDetail getShipmentRateDetail() {
     ...
     */
    public void setShipmentRateDetail(com.fedex.ws.rate.v9.ShipmentRateDetail shipmentRateDetail) {
        this.shipmentRateDetail = shipmentRateDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.RatedPackageDetail[] getRatedPackages() {
     ...
     */
    public void setRatedPackages(com.fedex.ws.rate.v9.RatedPackageDetail[] ratedPackages) {
        this.ratedPackages = ratedPackages;
    }

    public com.fedex.ws.rate.v9.RatedPackageDetail getRatedPackages(int i) {
        return this.ratedPackages[i];
    }

    public void setRatedPackages(int i, com.fedex.ws.rate.v9.RatedPackageDetail _value) {
