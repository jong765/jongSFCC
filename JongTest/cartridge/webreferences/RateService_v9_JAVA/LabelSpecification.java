...
public class LabelSpecification  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.LabelFormatType labelFormatType;
    ...
    private com.fedex.ws.rate.v9.ShippingDocumentImageType imageType;

    /* For thermal printer lables this indicates the size of the label
     * and the location of the doc tab if present. */
    private com.fedex.ws.rate.v9.LabelStockType labelStockType;

    /* This indicates if the top or bottom of the label comes out
     * of the printer first. */
    private com.fedex.ws.rate.v9.LabelPrintingOrientationType labelPrintingOrientation;
    ...
    private com.fedex.ws.rate.v9.LabelRotationType labelRotation;

    /* If present, this contact and address information will replace
     * the return address information on the label. */
    private com.fedex.ws.rate.v9.ContactAndAddress printedLabelOrigin;

    /* Allows customer-specified control of label content. */
    private com.fedex.ws.rate.v9.CustomerSpecifiedLabelDetail customerSpecifiedDetail;

    public LabelSpecification() {
    }

    public LabelSpecification(
           com.fedex.ws.rate.v9.LabelFormatType labelFormatType,
           com.fedex.ws.rate.v9.ShippingDocumentImageType imageType,
           com.fedex.ws.rate.v9.LabelStockType labelStockType,
           com.fedex.ws.rate.v9.LabelPrintingOrientationType labelPrintingOrientation,
           com.fedex.ws.rate.v9.LabelRotationType labelRotation,
           com.fedex.ws.rate.v9.ContactAndAddress printedLabelOrigin,
           com.fedex.ws.rate.v9.CustomerSpecifiedLabelDetail customerSpecifiedDetail) {
     ...
     */
    public com.fedex.ws.rate.v9.LabelFormatType getLabelFormatType() {
     ...
     */
    public void setLabelFormatType(com.fedex.ws.rate.v9.LabelFormatType labelFormatType) {
        this.labelFormatType = labelFormatType;
    }
     ...
     *                 ZPLII = Zebra thermal printer language
     */
    public com.fedex.ws.rate.v9.ShippingDocumentImageType getImageType() {
        return imageType;
    }
     ...
     *                 ZPLII = Zebra thermal printer language
     */
    public void setImageType(com.fedex.ws.rate.v9.ShippingDocumentImageType imageType) {
        this.imageType = imageType;
    }
     ...
     * and the location of the doc tab if present.
     */
    public com.fedex.ws.rate.v9.LabelStockType getLabelStockType() {
     ...
     * and the location of the doc tab if present.
     */
    public void setLabelStockType(com.fedex.ws.rate.v9.LabelStockType labelStockType) {
        this.labelStockType = labelStockType;
    }
     ...
     * of the printer first.
     */
    public com.fedex.ws.rate.v9.LabelPrintingOrientationType getLabelPrintingOrientation() {
     ...
     * of the printer first.
     */
    public void setLabelPrintingOrientation(com.fedex.ws.rate.v9.LabelPrintingOrientationType labelPrintingOrientation) {
        this.labelPrintingOrientation = labelPrintingOrientation;
    }
     ...
     * clockwise, UPSIDE_DOWN=180 degrees, LEFT=90 degrees counterclockwise.
     */
    public com.fedex.ws.rate.v9.LabelRotationType getLabelRotation() {
     ...
     * clockwise, UPSIDE_DOWN=180 degrees, LEFT=90 degrees counterclockwise.
     */
    public void setLabelRotation(com.fedex.ws.rate.v9.LabelRotationType labelRotation) {
        this.labelRotation = labelRotation;
    }
     ...
     * the return address information on the label.
     */
    public com.fedex.ws.rate.v9.ContactAndAddress getPrintedLabelOrigin() {
     ...
     * the return address information on the label.
     */
    public void setPrintedLabelOrigin(com.fedex.ws.rate.v9.ContactAndAddress printedLabelOrigin) {
        this.printedLabelOrigin = printedLabelOrigin;
    }
     ...
     */
    public com.fedex.ws.rate.v9.CustomerSpecifiedLabelDetail getCustomerSpecifiedDetail() {
     ...
     */
    public void setCustomerSpecifiedDetail(com.fedex.ws.rate.v9.CustomerSpecifiedLabelDetail customerSpecifiedDetail) {
        this.customerSpecifiedDetail = customerSpecifiedDetail;
    }
