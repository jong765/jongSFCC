...
public class Weight  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.WeightUnits units;
    ...
    public Weight(
           com.fedex.ws.rate.v9.WeightUnits units,
     ...
     * See WeightUnits for the list of valid enumerated values.
     */
    public com.fedex.ws.rate.v9.WeightUnits getUnits() {
        return units;
    }
     ...
     * See WeightUnits for the list of valid enumerated values.
     */
    public void setUnits(com.fedex.ws.rate.v9.WeightUnits units) {
        this.units = units;
    }
