...
public class LiabilityCoverageDetail  implements java.io.Serializable {
    private com.fedex.ws.rate.v9.LiabilityCoverageType coverageType;

    /* Identifies the Liability Coverage Amount. For Jan 2010 this
     * value represents coverage amount per pound */
    private com.fedex.ws.rate.v9.Money coverageAmount;

    public LiabilityCoverageDetail() {
    }

    public LiabilityCoverageDetail(
           com.fedex.ws.rate.v9.LiabilityCoverageType coverageType,
           com.fedex.ws.rate.v9.Money coverageAmount) {
     ...
     * @return coverageType
     */
    public com.fedex.ws.rate.v9.LiabilityCoverageType getCoverageType() {
        return coverageType;
    }
     ...
     * @param coverageType
     */
    public void setCoverageType(com.fedex.ws.rate.v9.LiabilityCoverageType coverageType) {
        this.coverageType = coverageType;
    }
     ...
     * value represents coverage amount per pound
     */
    public com.fedex.ws.rate.v9.Money getCoverageAmount() {
     ...
     * value represents coverage amount per pound
     */
    public void setCoverageAmount(com.fedex.ws.rate.v9.Money coverageAmount) {
        this.coverageAmount = coverageAmount;
    }
