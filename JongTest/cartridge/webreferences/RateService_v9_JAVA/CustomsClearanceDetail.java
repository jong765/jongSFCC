...
public class CustomsClearanceDetail  implements java.io.Serializable {
     ...
     * Services. */
    private com.fedex.ws.rate.v9.Party broker;

    /* Interacts both with properties of the shipment and contractual
     * relationship with the shipper. */
    private com.fedex.ws.rate.v9.ClearanceBrokerageType clearanceBrokerage;
    ...
    private com.fedex.ws.rate.v9.Party importerOfRecord;
    ...
    private com.fedex.ws.rate.v9.RecipientCustomsId recipientCustomsId;

    /* Indicates how payment of duties for the shipment will be made. */
    private com.fedex.ws.rate.v9.Payment dutiesPayment;
    ...
    private com.fedex.ws.rate.v9.Money customsValue;

    /* Identifies responsibilities with respect to loss, damage, etc. */
    private com.fedex.ws.rate.v9.FreightOnValueType freightOnValue;

    /* Documents amount paid to third party for coverage of shipment
     * content. */
    private com.fedex.ws.rate.v9.Money insuranceCharges;
    ...
    private com.fedex.ws.rate.v9.CommercialInvoice commercialInvoice;
    ...
    private com.fedex.ws.rate.v9.Commodity[] commodities;

    /* Country specific details of an International shipment. */
    private com.fedex.ws.rate.v9.ExportDetail exportDetail;
    ...
    private com.fedex.ws.rate.v9.RegulatoryControlType[] regulatoryControls;

    public CustomsClearanceDetail() {
    }

    public CustomsClearanceDetail(
           com.fedex.ws.rate.v9.Party broker,
           com.fedex.ws.rate.v9.ClearanceBrokerageType clearanceBrokerage,
           com.fedex.ws.rate.v9.Party importerOfRecord,
           com.fedex.ws.rate.v9.RecipientCustomsId recipientCustomsId,
           com.fedex.ws.rate.v9.Payment dutiesPayment,
           com.fedex.ws.rate.v9.InternationalDocumentContentType documentContent,
           com.fedex.ws.rate.v9.Money customsValue,
           com.fedex.ws.rate.v9.FreightOnValueType freightOnValue,
           com.fedex.ws.rate.v9.Money insuranceCharges,
           java.lang.Boolean partiesToTransactionAreRelated,
           com.fedex.ws.rate.v9.CommercialInvoice commercialInvoice,
           com.fedex.ws.rate.v9.Commodity[] commodities,
           com.fedex.ws.rate.v9.ExportDetail exportDetail,
           com.fedex.ws.rate.v9.RegulatoryControlType[] regulatoryControls) {
           this.broker = broker;
     ...
     * Services.
     */
    public com.fedex.ws.rate.v9.Party getBroker() {
        return broker;
    }
     ...
     * Services.
     */
    public void setBroker(com.fedex.ws.rate.v9.Party broker) {
        this.broker = broker;
    }
     ...
     * relationship with the shipper.
     */
    public com.fedex.ws.rate.v9.ClearanceBrokerageType getClearanceBrokerage() {
     ...
     * relationship with the shipper.
     */
    public void setClearanceBrokerage(com.fedex.ws.rate.v9.ClearanceBrokerageType clearanceBrokerage) {
        this.clearanceBrokerage = clearanceBrokerage;
    }
     ...
     *                 Importer/Address/CountryCode
     */
    public com.fedex.ws.rate.v9.Party getImporterOfRecord() {
     ...
     *                 Importer/Address/CountryCode
     */
    public void setImporterOfRecord(com.fedex.ws.rate.v9.Party importerOfRecord) {
        this.importerOfRecord = importerOfRecord;
    }
     ...
     * the requirements on this information vary with destination country.
     */
    public com.fedex.ws.rate.v9.RecipientCustomsId getRecipientCustomsId() {
     ...
     * the requirements on this information vary with destination country.
     */
    public void setRecipientCustomsId(com.fedex.ws.rate.v9.RecipientCustomsId recipientCustomsId) {
        this.recipientCustomsId = recipientCustomsId;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Payment getDutiesPayment() {
     ...
     */
    public void setDutiesPayment(com.fedex.ws.rate.v9.Payment dutiesPayment) {
        this.dutiesPayment = dutiesPayment;
    }
     ...
     * and all child transactions
     */
    public com.fedex.ws.rate.v9.Money getCustomsValue() {
        return customsValue;
    }
     ...
     * and all child transactions
     */
    public void setCustomsValue(com.fedex.ws.rate.v9.Money customsValue) {
        this.customsValue = customsValue;
    }
     ...
     */
    public com.fedex.ws.rate.v9.FreightOnValueType getFreightOnValue() {
     ...
     */
    public void setFreightOnValue(com.fedex.ws.rate.v9.FreightOnValueType freightOnValue) {
        this.freightOnValue = freightOnValue;
    }
     ...
     * content.
     */
    public com.fedex.ws.rate.v9.Money getInsuranceCharges() {
     ...
     * content.
     */
    public void setInsuranceCharges(com.fedex.ws.rate.v9.Money insuranceCharges) {
        this.insuranceCharges = insuranceCharges;
    }
     ...
     * of a maximum of 20 commodity line items.
     */
    public com.fedex.ws.rate.v9.CommercialInvoice getCommercialInvoice() {
     ...
     * of a maximum of 20 commodity line items.
     */
    public void setCommercialInvoice(com.fedex.ws.rate.v9.CommercialInvoice commercialInvoice) {
        this.commercialInvoice = commercialInvoice;
    }
     ...
     * 4 occurances for this request.
     */
    public com.fedex.ws.rate.v9.Commodity[] getCommodities() {
        return commodities;
    }
     ...
     * 4 occurances for this request.
     */
    public void setCommodities(com.fedex.ws.rate.v9.Commodity[] commodities) {
        this.commodities = commodities;
    }

    public com.fedex.ws.rate.v9.Commodity getCommodities(int i) {
        return this.commodities[i];
    }

    public void setCommodities(int i, com.fedex.ws.rate.v9.Commodity _value) {
     ...
     */
    public com.fedex.ws.rate.v9.ExportDetail getExportDetail() {
        return exportDetail;
    }
     ...
     */
    public void setExportDetail(com.fedex.ws.rate.v9.ExportDetail exportDetail) {
        this.exportDetail = exportDetail;
    }
     ...
     * food/perishable items coming to US or PR from non-US/non-PR origin.
     */
    public com.fedex.ws.rate.v9.RegulatoryControlType[] getRegulatoryControls() {
     ...
     * food/perishable items coming to US or PR from non-US/non-PR origin.
     */
    public void setRegulatoryControls(com.fedex.ws.rate.v9.RegulatoryControlType[] regulatoryControls) {
        this.regulatoryControls = regulatoryControls;
    }

    public com.fedex.ws.rate.v9.RegulatoryControlType getRegulatoryControls(int i) {
        return this.regulatoryControls[i];
    }

    public void setRegulatoryControls(int i, com.fedex.ws.rate.v9.RegulatoryControlType _value) {
