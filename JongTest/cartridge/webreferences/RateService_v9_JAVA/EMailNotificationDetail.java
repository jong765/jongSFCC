...
public class EMailNotificationDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.EMailNotificationRecipient[] recipients;
    ...
    public EMailNotificationDetail(
           ...
           com.fedex.ws.rate.v9.EMailNotificationRecipient[] recipients) {
     ...
     * of the email and events to be notified on
     */
    public com.fedex.ws.rate.v9.EMailNotificationRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * of the email and events to be notified on
     */
    public void setRecipients(com.fedex.ws.rate.v9.EMailNotificationRecipient[] recipients) {
        this.recipients = recipients;
    }

    public com.fedex.ws.rate.v9.EMailNotificationRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, com.fedex.ws.rate.v9.EMailNotificationRecipient _value) {
