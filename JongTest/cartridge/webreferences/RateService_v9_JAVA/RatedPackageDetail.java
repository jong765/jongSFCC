...
public class RatedPackageDetail  implements java.io.Serializable {
     ...
     * provided). */
    private com.fedex.ws.rate.v9.TrackingId[] trackingIds;
    ...
    private com.fedex.ws.rate.v9.Money effectiveNetDiscount;

    /* Ground COD is package level. */
    private com.fedex.ws.rate.v9.Money adjustedCodCollectionAmount;

    private com.fedex.ws.rate.v9.OversizeClassType oversizeClass;

    /* Rate data that are tied to a specific package and rate type
     * combination. */
    private com.fedex.ws.rate.v9.PackageRateDetail packageRateDetail;

    public RatedPackageDetail() {
    }

    public RatedPackageDetail(
           com.fedex.ws.rate.v9.TrackingId[] trackingIds,
           org.apache.axis.types.NonNegativeInteger groupNumber,
           com.fedex.ws.rate.v9.Money effectiveNetDiscount,
           com.fedex.ws.rate.v9.Money adjustedCodCollectionAmount,
           com.fedex.ws.rate.v9.OversizeClassType oversizeClass,
           com.fedex.ws.rate.v9.PackageRateDetail packageRateDetail) {
     ...
     * provided).
     */
    public com.fedex.ws.rate.v9.TrackingId[] getTrackingIds() {
        return trackingIds;
    }
     ...
     * provided).
     */
    public void setTrackingIds(com.fedex.ws.rate.v9.TrackingId[] trackingIds) {
        this.trackingIds = trackingIds;
    }

    public com.fedex.ws.rate.v9.TrackingId getTrackingIds(int i) {
        return this.trackingIds[i];
    }

    public void setTrackingIds(int i, com.fedex.ws.rate.v9.TrackingId _value) {
     ...
     */
    public com.fedex.ws.rate.v9.Money getEffectiveNetDiscount() {
     ...
     */
    public void setEffectiveNetDiscount(com.fedex.ws.rate.v9.Money effectiveNetDiscount) {
        this.effectiveNetDiscount = effectiveNetDiscount;
    }
     ...
     */
    public com.fedex.ws.rate.v9.Money getAdjustedCodCollectionAmount() {
     ...
     */
    public void setAdjustedCodCollectionAmount(com.fedex.ws.rate.v9.Money adjustedCodCollectionAmount) {
        this.adjustedCodCollectionAmount = adjustedCodCollectionAmount;
    }
     ...
     */
    public com.fedex.ws.rate.v9.OversizeClassType getOversizeClass() {
        return oversizeClass;
    }
     ...
     * @param oversizeClass
     */
    public void setOversizeClass(com.fedex.ws.rate.v9.OversizeClassType oversizeClass) {
        this.oversizeClass = oversizeClass;
    }
     ...
     * combination.
     */
    public com.fedex.ws.rate.v9.PackageRateDetail getPackageRateDetail() {
     ...
     * combination.
     */
    public void setPackageRateDetail(com.fedex.ws.rate.v9.PackageRateDetail packageRateDetail) {
        this.packageRateDetail = packageRateDetail;
    }
