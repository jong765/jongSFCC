...
public class RateReplyDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.DayOfWeekType deliveryDayOfWeek;

    private java.util.Calendar deliveryTimestamp;

    private com.fedex.ws.rate.v9.CommitDetail[] commitDetails;
    ...
    private com.fedex.ws.rate.v9.SignatureOptionType signatureOption;

    /* The actual rate type of the charges for this package. */
    private com.fedex.ws.rate.v9.ReturnedRateType actualRateType;

    /* Each element contains all rate data for a single rate type. */
    private com.fedex.ws.rate.v9.RatedShipmentDetail[] ratedShipmentDetails;
    ...
    public RateReplyDetail(
           ...
           com.fedex.ws.rate.v9.DayOfWeekType deliveryDayOfWeek,
           java.util.Calendar deliveryTimestamp,
           com.fedex.ws.rate.v9.CommitDetail[] commitDetails,
           ...
           com.fedex.ws.rate.v9.SignatureOptionType signatureOption,
           com.fedex.ws.rate.v9.ReturnedRateType actualRateType,
           com.fedex.ws.rate.v9.RatedShipmentDetail[] ratedShipmentDetails) {
     ...
     */
    public com.fedex.ws.rate.v9.DayOfWeekType getDeliveryDayOfWeek() {
        return deliveryDayOfWeek;
    }
     ...
     */
    public void setDeliveryDayOfWeek(com.fedex.ws.rate.v9.DayOfWeekType deliveryDayOfWeek) {
        this.deliveryDayOfWeek = deliveryDayOfWeek;
    }
     ...
     */
    public com.fedex.ws.rate.v9.CommitDetail[] getCommitDetails() {
        return commitDetails;
    }
     ...
     * @param commitDetails
     */
    public void setCommitDetails(com.fedex.ws.rate.v9.CommitDetail[] commitDetails) {
        this.commitDetails = commitDetails;
    }

    public com.fedex.ws.rate.v9.CommitDetail getCommitDetails(int i) {
        return this.commitDetails[i];
    }

    public void setCommitDetails(int i, com.fedex.ws.rate.v9.CommitDetail _value) {
     ...
     */
    public com.fedex.ws.rate.v9.SignatureOptionType getSignatureOption() {
     ...
     */
    public void setSignatureOption(com.fedex.ws.rate.v9.SignatureOptionType signatureOption) {
        this.signatureOption = signatureOption;
    }
     ...
     */
    public com.fedex.ws.rate.v9.ReturnedRateType getActualRateType() {
     ...
     */
    public void setActualRateType(com.fedex.ws.rate.v9.ReturnedRateType actualRateType) {
        this.actualRateType = actualRateType;
    }
     ...
     */
    public com.fedex.ws.rate.v9.RatedShipmentDetail[] getRatedShipmentDetails() {
     ...
     */
    public void setRatedShipmentDetails(com.fedex.ws.rate.v9.RatedShipmentDetail[] ratedShipmentDetails) {
        this.ratedShipmentDetails = ratedShipmentDetails;
    }

    public com.fedex.ws.rate.v9.RatedShipmentDetail getRatedShipmentDetails(int i) {
        return this.ratedShipmentDetails[i];
    }

    public void setRatedShipmentDetails(int i, com.fedex.ws.rate.v9.RatedShipmentDetail _value) {
