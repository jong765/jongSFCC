...
public class ShippingDocumentDispositionDetail  implements java.io.Serializable {
    ...
    private com.fedex.ws.rate.v9.ShippingDocumentDispositionType dispositionType;

    /* Specifies how to organize all documents of this type. */
    private com.fedex.ws.rate.v9.ShippingDocumentGroupingType grouping;

    /* Specifies how to e-mail document images. */
    private com.fedex.ws.rate.v9.ShippingDocumentEMailDetail EMailDetail;

    /* Specifies how a queued document is to be printed. */
    private com.fedex.ws.rate.v9.ShippingDocumentPrintDetail printDetail;

    public ShippingDocumentDispositionDetail() {
    }

    public ShippingDocumentDispositionDetail(
           com.fedex.ws.rate.v9.ShippingDocumentDispositionType dispositionType,
           com.fedex.ws.rate.v9.ShippingDocumentGroupingType grouping,
           com.fedex.ws.rate.v9.ShippingDocumentEMailDetail EMailDetail,
           com.fedex.ws.rate.v9.ShippingDocumentPrintDetail printDetail) {
     ...
     */
    public com.fedex.ws.rate.v9.ShippingDocumentDispositionType getDispositionType() {
     ...
     */
    public void setDispositionType(com.fedex.ws.rate.v9.ShippingDocumentDispositionType dispositionType) {
        this.dispositionType = dispositionType;
    }
     ...
     */
    public com.fedex.ws.rate.v9.ShippingDocumentGroupingType getGrouping() {
        return grouping;
    }
     ...
     */
    public void setGrouping(com.fedex.ws.rate.v9.ShippingDocumentGroupingType grouping) {
        this.grouping = grouping;
    }
     ...
     */
    public com.fedex.ws.rate.v9.ShippingDocumentEMailDetail getEMailDetail() {
        return EMailDetail;
    }
     ...
     */
    public void setEMailDetail(com.fedex.ws.rate.v9.ShippingDocumentEMailDetail EMailDetail) {
        this.EMailDetail = EMailDetail;
    }
     ...
     */
    public com.fedex.ws.rate.v9.ShippingDocumentPrintDetail getPrintDetail() {
        return printDetail;
    }
     ...
     */
    public void setPrintDetail(com.fedex.ws.rate.v9.ShippingDocumentPrintDetail printDetail) {
        this.printDetail = printDetail;
    }
